                                            ...
                                            <tr data-id="{{ $item->id }}">
                                                ...
                                                <td class="text-center">
                                                    <div class="table-actions d-flex justify-content-center gap-1">
                                                        <a href="#" class="btn btn-primary" style="padding: 6px 10px; border-radius: 4px;" data-bs-toggle="offcanvas" data-bs-target="#sliderItemOffcanvas" onclick='editItem(@json($item))' data-bs-title="Edit">
                                                        ...
                                                        <button type="button" onclick="deleteItem({{ $item->id }})" class="btn btn-danger" style="padding: 6px 10px; border-radius: 4px;" data-bs-toggle="tooltip" title="Delete">
