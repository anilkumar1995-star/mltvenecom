                    ...
                    <div class="page-pretitle">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item">
                                    <a class="mb-0 d-inline-block fs-6 lh-1" href="{{ route('admin.simple-sliders.edit', $item->slider->id) }}">{{ strtoupper($item->slider->name) }}</a>
                                </li>
                                <li class="breadcrumb-item active" aria-current="page">
                                    <h1 class="mb-0 d-inline-block fs-6 lh-1">EDIT ITEM</h1>
                                </li>
                            </ol>
                        </nav>
                    </div>
                            ...
                            <div class="card-body">
                                <div class="form-body">
                                    <div class="mb-3 position-relative">
                                        ...
                                        <input class="form-control" placeholder="Title" name="title" type="text" id="title" value="{{ old('title', $item->title) }}">
                                    ...
                                    <div class="mb-3 position-relative">
                                        ...
                                        <input class="form-control" placeholder="Link" name="link" type="text" id="link" value="{{ old('link', $item->link) }}">
                                    ...
                                    <div class="mb-3 position-relative">
                                        ...
                                        <textarea class="form-control" rows="4" placeholder="Short description" id="description" name="description" cols="50">{{ old('description', $item->description) }}</textarea>
                                    </div>
                                    ...
                                    <div class="mb-3 position-relative">
                                        ...
                                        <input class="form-control" placeholder="0" name="order" type="number" id="order" value="{{ old('order', $item->order) }}">
