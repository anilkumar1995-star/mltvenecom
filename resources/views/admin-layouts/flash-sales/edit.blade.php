                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">
                                    <h1 class="mb-0 d-inline-block fs-6 lh-1">Edit Flash Sale</h1>
                                </li>
                            </ol>
                        </nav>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="form-body">
                                <div class="mb-3 position-relative">
                                    ...
                                    <input class="form-control" placeholder="Name" data-counter="120" name="name" type="text" id="name" value="{{ $flashSale->name }}" required>
                                </div>
                            </div>
                        </div>
                    </div>
                                            ...
                                            <a href="#" class="list-group-item list-group-item-action product-search-item" 
                                               ...
                                               style="display: none;">
                                                <div class="d-flex align-items-center">
                                                    <img src="{{ $product->image_url }}" alt="{{ $product->name }}" width="30" class="me-2 text-dark">
                                    ...
                                    <div class="list-group" id="selected-products-list">
                                        ...
                                        <div class="list-group-item product-item" data-id="{{ $product->id }}">
                                            <div class="d-flex align-items-center mb-2">
                                                <img src="{{ $product->image_url }}" alt="{{ $product->name }}" width="40" class="me-3 rounded">
                                                <div>
                                                    <a href="#" target="_blank" class="fw-bold text-dark">{{ $product->name }}</a>
                                                </div>
                                                <div class="ms-auto">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="number" class="form-control" name="products[{{ $product->id }}][price]" value="{{ $product->pivot->price }}" step="0.01" required>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <label class="form-label">Quantity <span class="text-danger">*</span></label>
                                                    <input type="number" class="form-control" name="products[{{ $product->id }}][quantity]" value="{{ $product->pivot->quantity }}" min="1" required>
                                                </div>
                                            </div>
                                        </div>
                                        @endforeach
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <select class="form-select" name="status" id="status" required>
                                <option value="published" {{ $flashSale->status == 'published' ? 'selected' : '' }}>Published</option>
                                <option value="draft" {{ $flashSale->status == 'draft' ? 'selected' : '' }}>Draft</option>
                                <option value="closed" {{ $flashSale->status == 'closed' ? 'selected' : '' }}>Closed</option>
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="mb-3 position-relative">
                                <div class="input-icon">
                                    ...
                                    <input class="form-control form-date-time" name="end_date" type="text" id="end_date" value="{{ $flashSale->end_date->format('Y-m-d H:i:s') }}" placeholder="Y-m-d H:i:s" required>
                                </div>
                            </div>
                        </div>
                    </div>
