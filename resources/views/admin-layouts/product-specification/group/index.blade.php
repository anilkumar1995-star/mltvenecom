        ...
        <div class="container-xl">
            ...
            <div class="card has-actions has-filter">
                @section('table_actions')
                    <a href="{{ route('admin.group.create') }}" class="btn btn-primary d-flex align-items-center">
                ...
                <div class="card-table mt-1">
                    <div class="table-responsive table-has-actions table-has-filter">
                        <table class="table card-table table-vcenter table-hover datatable" id="groupsTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('admin.group.edit', $row->id) }}" class="fw-bold text-dark text-decoration-none">
                                            {{ $row->name }}
                                        </a>
                                    </td>
                                    <td>{{ $row->description }}</td>
                                    <td class="text-center small">{{ $row->created_at }}</td>
                                    <td class="text-end">
                                        <div class="btn-group">
                                            <a href="{{ route('admin.group.edit', $row->id) }}" class="btn btn-sm btn-outline-info" title="Edit">
                                                <i class="fa fa-edit"></i>
                                            </a>
                                            <button type="button" class="btn btn-sm btn-outline-danger delete-confirm-btn" 
                                                data-url="{{ route('admin.group.Delete', ['id' => $row->id]) }}"
                                                title="Delete">
...
@push('scripts')
    @include('admin-layouts.partials.table-scripts', [
        'tableId'       => 'groupsTable',
        'bulkDeleteUrl' => route('admin.group.bulk-delete')
    ])
@endpush