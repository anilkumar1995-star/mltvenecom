...
@section('title','Create Specification Table')
@section('content')
...
<div class="page-wrapper">
                ...
                <div class="col">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><a>Create Table</a></li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <main class="page-body page-content">
        <div class="container-xl">
            <form method="POST" action="{{ route('admin.producttable.store') }}" id="tableForm">
                @csrf
                <div class="row">
                    <div class="col-md-9">
                        <div class="card mb-3">
