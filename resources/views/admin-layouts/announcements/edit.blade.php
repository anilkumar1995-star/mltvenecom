                ...
                <div class="row g-2 align-items-center">
                    <div class="col">
                        <h2 class="page-title text-muted" style="font-size: 14px; font-weight: 500;">
                            Edit Announcement "{{ $announcement->name }}"
                        </h2>
                    </div>
                    ...
                    <div class="col">
                        <nav aria-label="breadcrumb" class="mb-2">
                            <ol class="breadcrumb" style="font-size: 11px; font-weight: 600; text-transform: uppercase; margin-bottom: 0;">
                                ...
                                <li class="breadcrumb-item active text-muted" aria-current="page">EDIT ANNOUNCEMENT "{{ $announcement->name }}"</li>
                            </ol>
                        </nav>
                        <h2 class="page-title fw-bold" style="font-size: 20px; color: #1e293b;">
                            Edit Announcement "{{ $announcement->name }}"
                        </h2>
                    </div>
                </div>
                        ...
                        <div class="card mb-3 shadow-none border">
                            <div class="card-body p-4">
                                <div class="mb-4">
                                    ...
                                    <input type="text" class="form-control form-control-shofy" name="name" placeholder="Enter announcement name" value="{{ old('name', $announcement->name) }}" required>
                                ...
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control flatpickr" placeholder="2026-03-14 00:00:0" name="start_date" id="startDatePicker" value="{{ old('start_date', $announcement->start_date ? $announcement->start_date->format('Y-m-d H:i:s') : '') }}">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control flatpickr" placeholder="2026-03-14 00:00:0" name="end_date" id="endDatePicker" value="{{ old('end_date', $announcement->end_date ? $announcement->end_date->format('Y-m-d H:i:s') : '') }}">
                                    ...
                                    <div id="actionFields" style="display: {{ old('has_action', $announcement->has_action) ? 'block' : 'none' }};">
                                        <div class="row g-3">
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" class="form-control form-control-shofy" name="action_label" placeholder="e.g., Learn More, Shop Now" value="{{ old('action_label', $announcement->action_label) }}">
                                            </div>
                                            <div class="col-md-6">
                                                <label class="form-label fw-bold mb-2">Action URL</label>
                                                <input type="text" class="form-control form-control-shofy" name="action_url" placeholder="https://example.com/page" value="{{ old('action_url', $announcement->action_url) }}">
                                            </div>
                                        </div>
                                        <div class="mt-3">
