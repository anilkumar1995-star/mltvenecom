...
<div class="container-xl">
    <div class="page-header d-print-none mb-3">
        <div class="row align-items-center">
            <div class="col">
                <h2 class="page-title">Edit announcement: {{ $announcement->name }}</h2>
            </div>
                ...
                <div class="card mb-3">
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name', $announcement->name) }}" placeholder="Name" required>
                            @error('name') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        </div>

                        <div class="mb-3">
                            <label class="form-label required">Content</label>
                            <textarea class="form-control editor" name="content" id="editor" rows="10">{{ old('content', $announcement->content) }}</textarea>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control flatpickr" name="start_date" value="{{ old('start_date', $announcement->start_date ? \Carbon\Carbon::parse($announcement->start_date)->format('Y-m-d H:i:s') : '') }}">
                            </div>
                            <div class="col-md-6">
                                <label class="form-label">End Date</label>
                                <input type="text" class="form-control flatpickr" name="end_date" value="{{ old('end_date', $announcement->end_date ? \Carbon\Carbon::parse($announcement->end_date)->format('Y-m-d H:i:s') : '') }}">
                            </div>
                        </div>
                        ...
                        <div id="actionFields" class="row mb-3" style="display: {{ old('has_action', $announcement->has_action) ? 'flex' : 'none' }};">
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Action label</label>
                                <input type="text" class="form-control" name="action_label" value="{{ old('action_label', $announcement->action_label) }}">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Action URL</label>
                                <input type="text" class="form-control" name="action_url" value="{{ old('action_url', $announcement->action_url) }}">
                            </div>
                            <div class="col-12">
            ...
            <div class="col-md-3">
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <button class="btn btn-outline-secondary w-100" type="submit" name="save_and_exit" value="1">Update & Exit</button>
                    </div>
                </div>
