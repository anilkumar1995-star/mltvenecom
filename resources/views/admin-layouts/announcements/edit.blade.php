                ...
                <div class="col">
                    <div class="page-pretitle breadcrumb-arrows mb-2">
                        <ol class="breadcrumb" aria-label="breadcrumbs">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><h1 class="mb-0 d-inline-block">EDIT ANNOUNCEMENT "{{ $announcement->name }}"</h1></li>
                        </ol>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card mb-3">
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="name" placeholder="Enter announcement name" value="{{ old('name', $announcement->name) }}" required>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="input-icon">
                                            <input class="form-control flatpickr" placeholder="Select date" name="start_date" value="{{ old('start_date', $announcement->start_date ? $announcement->start_date->format('Y-m-d H:i:s') : '') }}">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="input-icon">
                                            <input class="form-control flatpickr" placeholder="Select date" name="end_date" value="{{ old('end_date', $announcement->end_date ? $announcement->end_date->format('Y-m-d H:i:s') : '') }}">
                                            <span class="input-icon-addon">
                                                <i class="far fa-calendar-alt"></i>
                                            </span>
                                        </div>
                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body pt-1">
                                <label class="form-check form-switch cursor-pointer mb-2">
                                    <input class="form-check-input" type="checkbox" name="is_active" value="1" {{ $announcement->is_active ? 'checked' : '' }}>
