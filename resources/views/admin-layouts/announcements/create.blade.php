                        ...
                        <div class="card mb-3 shadow-sm border-0">
                            <div class="card-body p-4">
                                <div class="mb-4">
                                    ...
                                    <input type="text" class="form-control" name="name" placeholder="Enter announcement name" value="{{ old('name') }}" required style="border-radius: 4px; border-color: #e2e8f0; padding: 10px 12px; font-size: 14px;">
                                ...
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control flatpickr" placeholder="2026-03-14 00:00:0" name="start_date" id="startDatePicker" value="{{ old('start_date', now()->format('Y-m-d H:i:s')) }}" style="border-radius: 4px 0 0 4px; border-color: #e2e8f0;">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control flatpickr" placeholder="2026-03-14 00:00:0" name="end_date" id="endDatePicker" value="{{ old('end_date') }}" style="border-radius: 4px 0 0 4px; border-color: #e2e8f0;">
                                    ...
                                    <div id="actionFields" style="display: {{ old('has_action') ? 'block' : 'none' }};">
                                        <div class="row g-3">
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" class="form-control" name="action_label" placeholder="e.g., Learn More, Shop Now" value="{{ old('action_label') }}" style="border-radius: 4px; border-color: #e2e8f0;">
                                            </div>
                                            <div class="col-md-6">
                                                <label class="form-label fw-bold mb-2" style="font-size: 13px;">Action URL</label>
                                                <input type="text" class="form-control" name="action_url" placeholder="https://example.com/page" value="{{ old('action_url') }}" style="border-radius: 4px; border-color: #e2e8f0;">
                                            </div>
                                        </div>
                                        <div class="mt-3">
                        ...
                        <div class="card mb-3 shadow-none border-0 overflow-hidden">
                            ...
                            <div class="card-body p-3 bg-white">
                                <div class="d-flex justify-content-between align-items-center">
                                    <label class="form-check form-switch cursor-pointer mb-0">
                                        <input class="form-check-input" type="checkbox" name="is_active" value="1" {{ old('is_active', true) ? 'checked' : '' }} style="width: 32px; height: 16px;">
                                    </label>
                                </div>
