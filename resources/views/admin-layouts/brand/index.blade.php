...
<div class="page-wrapper">
                ...
                <div class="card mb-3 table-configuration-wrap" style="display: none;">
                    <div class="card-body">
                        ...
                        <div class="wrapper-filter">
                            ...
                            <form method="GET" action="{{ route('admin.brand.Index') }}" accept-charset="UTF-8"
                                class="filter-form">
                                ...
                                <div class="btn-list">
                                    ...
                                    <a class="btn btn-icon   w-6" style="display: none;" type="button"
                                        href="{{ route('admin.brand.Index') }}" data-bb-toggle="datatable-reset-filter">
                ...
                <div class="card has-actions has-filter">
                    ...
                    <div class="card-table">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th width="150" class="text-secondary text-uppercase fs-6 text-center">CREATED
                                            AT</th>
                                        <th width="120" class="text-secondary text-uppercase fs-6 text-center">STATUS
                                        </th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="text-center"><input type="checkbox"
                                                class="form-check-input row-checkbox" value="{{ $brand->id }}"></td>
                                        ...
                                        <td><a href="{{ route('admin.brand.edit', $brand) }}"
                                                class="text-primary text-decoration-none fw-medium">{{ $brand->name
                                                }}</a></td>
                                        <td>
                                            <span
                                                class="badge {{ $brand->is_featured === 1 ? 'bg-success text-success-fg' : 'bg-danger text-danger-fg' }} rounded-pill px-3">
                                        ...
                                        <td class="text-center">
                                            <span
                                                class="badge {{ $brand->status == 'published' ? 'bg-success text-success-fg' : 'bg-danger text-danger-fg' }} rounded-pill px-2">
                                        ...
                                        <td class="text-center no-column-visibility text-nowrap">
                                            <div class="d-flex justify-content-center gap-1">
                                                <a href="{{ route('admin.brand.edit', $brand) }}"
                                                    ...
                                                    title="Edit">
                                                    <svg class="icon fs-4" xmlns="http://www.w3.org/2000/svg" width="24"
                                                ...
                                                <button type="button" onclick="deleteBrand({{ $brand->id }})"
                                                    class="btn btn-sm btn-icon btn-danger" data-bs-toggle="tooltip"
                                                    title="Delete">
                                                    <svg class="icon fs-4" xmlns="http://www.w3.org/2000/svg" width="24"
                                                        height="24" viewBox="0 0 24 24" fill="none"
                                                        stroke="currentColor" stroke-width="2" stroke-linecap="round"
                        ...
                        <div class="card-footer d-flex align-items-center border-top-0 pt-0">
                            <p class="m-0 text-muted small">Show from 1 to {{ count($brands) }} in <span
                                    class="badge bg-secondary text-white rounded-pill px-2">{{ count($brands) }}</span>
                                records</p>
                        </div>
                    </div>
                </div>
    ...
    <style>
        ...
        .table-responsive {
            ...
            /* Allow dropdown to overflow the table */
        }
