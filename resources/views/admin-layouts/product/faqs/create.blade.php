...
<div class="page-wrapper">
    ...
    <main class="page-body page-content">
        <div class="container-xl">
            <form id="faq-form" action="{{ route('admin.faqs.store') }}" method="POST">
                @csrf
                <div class="row">
                    <div class="col-md-8">
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="question" class="form-control" required placeholder="e.g. What is the warranty period?">
                                </div>
                                <div class="mb-3">
