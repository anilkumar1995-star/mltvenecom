...
<div class="page-wrapper">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">
                                    <h1 class="mb-0 d-inline-block fs-6 lh-1">Create new gallery</h1>
                                </li>
                            </ol>
                        </nav>
                    </div>
    ...
    <main class="page-body page-content">
        <div class="container-xl">
            ...
            <form method="POST" action="{{ route('admin.galleries.store') }}" accept-charset="UTF-8" id="botble-gallery-forms-gallery-form" class="js-base-form dirty-check" novalidate="novalidate" enctype="multipart/form-data">
                @csrf
                            ...
                            <div class="card-body">
                                <div class="form-body">
                                    ...
                                    <div class="mb-3 position-relative">
                                        ...
                                        <input class="form-control @error('name') is-invalid @enderror" data-counter="250" placeholder="Name" required="required" name="name" type="text" value="{{ old('name') }}" id="name" aria-required="true">
                                    ...
                                    <div class="mb-3 position-relative">
                                        ...
                                        <textarea class="form-control form-control editor-ckeditor ays-ignore @error('description') is-invalid @enderror" data-counter="400" rows="4" placeholder="Short description" id="description" name="description" cols="50">{{ old('description') }}</textarea>
                                        @error('description') <div class="invalid-feedback">{{ $message }}</div> @enderror
                                    </div>

                                    <div class="mb-3 position-relative">
                                        <label class="form-label" for="order">Sort order</label>
                                        <input class="form-control" data-counter="250" placeholder="Order by" name="order" type="number" value="{{ old('order', 0) }}" id="order">
                                    </div>

                                    <div class="mb-3 position-relative">
                                        <label class="form-check form-switch d-inline-block mt-2">
                                            <input name="is_featured" type="hidden" value="0">
                                            <input class="form-check-input" name="is_featured" type="checkbox" value="1" id="is_featured" {{ old('is_featured') ? 'checked' : '' }}>
                                    ...
                                    <div style="width: 8rem" class="preview-image-wrapper mb-1">
                                        <div class="preview-image-inner position-relative d-inline-block">
                                            <a class="image-box-actions custom-image-trigger" href="javascript:void(0)">
                                                <img id="gallery-image-preview" class="preview-image default-image img-fluid rounded border" data-default="{{ asset('vendor/core/core/base/images/placeholder.png') }}" src="{{ asset('vendor/core/core/base/images/placeholder.png') }}" alt="Preview image" style="max-height: 150px; width: auto; object-fit: cover;">
                                                <span class="image-picker-backdrop"></span>
                                            </a>
                                            <button class="btn btn-pill btn-icon btn-sm image-picker-remove-button p-0 position-absolute top-0 end-0 bg-white" id="gallery-remove-image-btn" style="display: none; transform: translate(30%, -30%); z-index: 10;" type="button" title="Remove image">
