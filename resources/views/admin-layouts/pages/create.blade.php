 ...
 <div class="page-wrapper">
                ...
                <main class="page-body page-content">
                    <div class="container-xl">
                        ...
                        <form method="POST" action="{{ route('admin.pages.store') }}" accept-charset="UTF-8" id="botble-page-forms-page-form" class="js-base-form dirty-check">
                            @csrf
                                        ...
                                        <div class="card-body">
                                            <div class="form-body">
                                                ...
                                                <div class="mb-3 position-relative">
                                                    ...
                                                    <input class="form-control" data-counter="120" placeholder="Name" required="required" name="name" type="text" id="name">
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="mb-3 position-relative">
                                                            ...
                                                            <div class="input-group input-group-flat">
                                                                ...
                                                                <input
                                                                    class="form-control ps-0" type="text" name="slug" id="slug" required="required" />
                                                        ...
                                                        <small class="form-hint mt-n2 text-truncate">Preview: <a
                                                                href="https://shofy-grocery.botble.com/"
                                                                target="_blank">https://shofy-grocery.botble.com/</a></small>
                                                        <input
                                                            class="slug-current"
                                                            name="slug"
                                                            type="hidden"
                                                ...
                                                <div class="mb-3 position-relative">
                                                    ...
                                                    <textarea class="form-control form-control editor-ckeditor ays-ignore" data-counter="100000" rows="4" placeholder="Write your content" with-short-code id="content" name="content" cols="50"></textarea>
