                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">
                                    <h1 class="mb-0 d-inline-block fs-6 lh-1">Edit "{{ $page->name }}"</h1>
                                </li>
                            </ol>
                        </nav>
                    </div>
            ...
            <form action="{{ route('admin.pages.update', $page->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <div class="card mb-3">
                            <div class="card-header">
                                <ul class="nav nav-tabs card-header-tabs" data-bs-toggle="tabs" role="tablist">
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <a href="#tabs-revisions" class="nav-link" data-bs-toggle="tab">Revision History</a>
                                    </li>
                                </ul>
                            </div>
                            <div class="card-body">
                                    ...
                                    <div class="tab-pane active show" id="tabs-detail" role="tabpanel">
                                        <div class="mb-3 position-relative">
                                            ...
                                            <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" 
                                                value="{{ old('name', $page->name) }}" placeholder="Name" required>
                                            @error('name')
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control bg-light" readonly value="{{ url('/') }}">
                                        </div>
                                        ...
                                        <div class="mb-3 position-relative">
                                            ...
                                            <textarea class="form-control @error('description') is-invalid @enderror" 
                                                ...
                                                placeholder="Short description">{{ old('description', $page->description) }}</textarea>
                                            @error('description')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="mb-3 position-relative">
                                            ...
                                            <textarea class="form-control editor-ckeditor ays-ignore @error('content') is-invalid @enderror" 
                                                ...
                                                placeholder="Write your content" cols="50">{{ old('content', $page->content) }}</textarea>
                                            @error('content')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    </div>
                                    <div class="tab-pane" id="tabs-revisions" role="tabpanel">
                        ...
                        {{-- FAQ / Additional Meta Boxes could go here --}}
                    </div>
                            ...
                            <div class="card-body">
                                <div class="image-box text-center">
                                    <div class="image-box-preview mb-2">
                                        @if($page->image)
                                            <img src="{{ \App\Helpers\ImageHelper::getImageUrl() . $page->image }}" 
