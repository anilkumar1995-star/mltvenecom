    ...
    <aside class="navbar navbar-vertical navbar-expand-lg flex-auto" data-bs-theme="dark" id="sidebar-menu-main">
        ...
        <div class="container-xl"><button class="navbar-toggler" type="button" data-bs-toggle="collapse"
            ...
            <div class="navbar-nav flex-row d-lg-none">
                <div class="dropdown nav-item"><a href="{{ route('admin.dashboard') }}"
                    ...
                    <div class="dropdown-menu dropdown-menu-arrow dropdown-menu-end"><a class="dropdown-item"
                            href="{{ route('admin.profile.edit') }}"><svg
            ...
            <div class="collapse navbar-collapse" id="sidebar-menu">
                <ul class="navbar-nav">
                    <li class="nav-item"><a class="nav-link nav-priority--9999" href="{{ route('admin.dashboard') }}" id="cms-core-dashboard" title="Dashboard"><span
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu animate slideIn dropdown-menu-start">
                            ...
                            {{-- <a class="dropdown-item nav-priority-0" href="{{ url("/") }}/admin/ecommerce/reports"
                                id="cms-plugins-ecommerce-report" title="Report"><span
                                    class="nav-link-icon d-md-none d-lg-inline-block" title="Report"><svg
                                        class="icon svg-icon-ti-ti-report-analytics" xmlns="http://www.w3.org/2000/svg"
                                        width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                        stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                        <path
                            ...
                            <a class="dropdown-item nav-priority-10" href="{{ url("/") }}/admin/ecommerce/orders"
                                id="cms-plugins-ecommerce-order" title="Orders"><span
                                    class="nav-link-icon d-md-none d-lg-inline-block" title="Orders"><svg
                                        class="icon svg-icon-ti-ti-truck-delivery" xmlns="http://www.w3.org/2000/svg"
                                        width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                        stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                        <path d="M7 17m-2 0a2 2 0 1 0 4 0a2 2 0 1 0 -4 0"></path>
                                        <path d="M17 17m-2 0a2 2 0 1 0 4 0a2 2 0 1 0 -4 0"></path>
                                ...
                                class="dropdown-item nav-priority-20" href="{{ url("/")
                                }}/admin/ecommerce/incomplete-orders" id="cms-plugins-ecommerce-incomplete-order"
                                title="Incomplete orders"><span class="nav-link-icon d-md-none d-lg-inline-block"
                                ...
                                }}/admin/ecommerce/order-returns" id="cms-plugins-ecommerce-order-return"
                                title="Order returns"><span class="nav-link-icon d-md-none d-lg-inline-block"
                                    title="Order returns"><svg class="icon svg-icon-ti-ti-basket-down"
                                        xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                        fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                        stroke-linejoin="round">
                                        <path d="M17 10l-2 -6"></path>
                                        ...
                                        data-url="{{ url("/") }}/admin/menu-items-count"
                                        style="display: none;"></span></span></a><a
                                class="dropdown-item nav-priority-40" href="{{ url("/") }}/admin/ecommerce/shipments"
                                ...
                                </span></a><a class="dropdown-item nav-priority-50" href="{{ url("/")
                                }}/admin/ecommerce/invoices" id="cms-plugins-ecommerce-invoice" title="Invoices"><span
                                    class="nav-link-icon d-md-none d-lg-inline-block" title="Invoices"><svg
                                        class="icon svg-icon-ti-ti-file-invoice" xmlns="http://www.w3.org/2000/svg"
                                        width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                        stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            ...
                            {{-- <a class="dropdown-item nav-priority-70" href="{{ url("/")
                                ...
                                </span></a><a class="dropdown-item nav-priority-80" href="{{ url("/")
                                }}/admin/ecommerce/product-inventory" id="cms-plugins-ecommerce-product-inventory"
                                title="Product Inventory"><span class="nav-link-icon d-md-none d-lg-inline-block"
                            ...
                            <a class="dropdown-item nav-priority-160" href="{{ url("/") }}/admin/ecommerce/reviews"
                                id="cms-ecommerce-review" title="Reviews"><span
                                    class="nav-link-icon d-md-none d-lg-inline-block" title="Reviews"><svg
                                        class="icon svg-icon-ti-ti-star" xmlns="http://www.w3.org/2000/svg" width="24"
                                        height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                        stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                ...
                                </span></a><a class="dropdown-item nav-priority-180" href="{{ url("/")
                                }}/admin/ecommerce/discounts" id="cms-plugins-ecommerce-discount"
                                title="Discounts"><span class="nav-link-icon d-md-none d-lg-inline-block"
                                    title="Discounts"><svg class="icon svg-icon-ti-ti-discount"
                                        xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                        fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                        stroke-linejoin="round">
                    ...
                    <li class="nav-item dropdown"><a class="nav-link dropdown-toggle nav-priority-0" href="{{ url('admin#cms-plugins-marketplace') }}" id="cms-plugins-marketplace" data-bs-toggle="dropdown"
                        ...
                        <div class="dropdown-menu animate slideIn dropdown-menu-start"><a
                                ...
                                class="dropdown-item nav-priority-2" href="{{ route('admin.marketplace.withdrawls') }}"
                                ...
                                title="Vendors"><span class="nav-link-icon d-md-none d-lg-inline-block"
                                    title="Vendors"><svg class="icon svg-icon-ti-ti-users"
                                        xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                        fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                        stroke-linejoin="round">
                                        <path d="M9 7m-4 0a4 4 0 1 0 8 0a4 4 0 1 0 -8 0"></path>
                                ...
                                href="{{ route('admin.marketplace.unverified-vendors') }}"
                                id="cms-plugins-marketplace-unverified-vendor" title="Unverified vendors"><span
                                    ...
                                    <span
                                        ...
                                        data-url="{{ url("/") }}/admin/menu-items-count"
                                        style="display: none;"></span></span></a><a
                                class="dropdown-item nav-priority-10" href="{{ url("/") }}/admin/marketplaces/messages"
                    ...
                    <li class="nav-item dropdown"><a class="nav-link dropdown-toggle nav-priority-3" href="{{ url("/")
                             ...
                             role="button" aria-expanded="false" title="Payments"><span
                                class="nav-link-icon d-md-none d-lg-inline-block" title="Payments"><svg
                                    ...
                                    style="display: none;"></span></span></a>
                        <div class="dropdown-menu animate slideIn dropdown-menu-start"><a
                                class="dropdown-item nav-priority-0" href="{{ url("/") }}/admin/payments/transactions"
                                id="cms-plugins-payments-all" title="Transactions"><span
                                    class="nav-link-icon d-md-none d-lg-inline-block" title="Transactions"><svg
                                        class="icon svg-icon-ti-ti-list" xmlns="http://www.w3.org/2000/svg" width="24"
                                        height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                        stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                        ...
                                        data-url="{{ url("/") }}/admin/menu-items-count"
                                        style="display: none;"></span></span></a><a class="dropdown-item nav-priority-1"
                                href="{{ url("/") }}/admin/payments/logs" id="cms-plugins-payment-logs"
                                ...
                                </span></a><a class="dropdown-item nav-priority-1" href="{{ url("/")
                                }}/admin/payments/methods" id="cms-plugins-payment-methods" title="Payment methods">
                    ...
                    <li class="nav-item"><a class="nav-link nav-priority-5" href="{{ url("/") }}/admin/galleries"
                            id="cms-plugins-gallery" title="Galleries"><span
                                class="nav-link-icon d-md-none d-lg-inline-block" title="Galleries"><svg
                                    class="icon svg-icon-ti-ti-camera" xmlns="http://www.w3.org/2000/svg" width="24"
                                    height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round">
                                    <path
                    ...
                    <li class="nav-item"><a class="nav-link nav-priority-5" href="{{ url("/") }}/admin/testimonials"
                            id="cms-plugins-testimonial" title="Testimonials"><span
                                class="nav-link-icon d-md-none d-lg-inline-block" title="Testimonials"><svg
                                    class="icon svg-icon-ti-ti-user-star" xmlns="http://www.w3.org/2000/svg" width="24"
                                    height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round">
                                    <path d="M8 7a4 4 0 1 0 8 0a4 4 0 0 0 -8 0"></path>
                        ...
                        <div class="dropdown-menu animate slideIn dropdown-menu-start"><a
                                ...
                                id="cms-plugins-contact-list" title="Contacts"><span
                                    class="nav-link-icon d-md-none d-lg-inline-block" title="Contacts"><svg
                                        class="icon svg-icon-ti-ti-cube" xmlns="http://www.w3.org/2000/svg" width="24"
                                        height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                        stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                        <path
                                ...
                                }}/admin/contacts/custom-fields" id="cms-plugins-contact-custom-fields"
                                title="Custom Fields"><span class="nav-link-icon d-md-none d-lg-inline-block"
                                    title="Custom Fields"><svg class="icon svg-icon-ti-ti-cube-plus"
                                        xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                        fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                        stroke-linejoin="round">
                                        <path
                 ...
                 {{--   <li class="nav-item"><a class="nav-link nav-priority-430" href="{{ url("/") }}/admin/newsletters"
                        ...
                        <div class="dropdown-menu animate slideIn dropdown-menu-start"><a
                                ...
                                id="cms-plugins-country" title="Countries"><span
                                    class="nav-link-icon d-md-none d-lg-inline-block" title="Countries"><svg
                                        class="icon svg-icon-ti-ti-flag" xmlns="http://www.w3.org/2000/svg" width="24"
                                        height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                        stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                ...
                                </span></a><a class="dropdown-item nav-priority-10" href="{{ url("/") }}/admin/states"
                                id="cms-plugins-state" title="States"><span
                                    class="nav-link-icon d-md-none d-lg-inline-block" title="States"><svg
                                        class="icon svg-icon-ti-ti-map" xmlns="http://www.w3.org/2000/svg" width="24"
                                        height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                        stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                ...
                                class="dropdown-item nav-priority-30" href="{{ url("/") }}/admin/locations/bulk-import"
                                id="cms-plugins-location-bulk-import" title="Location Importer"><span
                                    class="nav-link-icon d-md-none d-lg-inline-block" title="Location Importer"><svg
                                        class="icon svg-icon-ti-ti-package-import" xmlns="http://www.w3.org/2000/svg"
                                        width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                        stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                ...
                                </span></a><a class="dropdown-item nav-priority-40" href="{{ url("/")
                                }}/admin/locations/export" id="cms-plugins-location-export"
                    ...
                    <li class="nav-item"><a class="nav-link nav-priority-999" href="{{ url("/") }}/admin/media"
                            id="cms-core-media" title="Media"><span class="nav-link-icon d-md-none d-lg-inline-block"
                                title="Media"><svg class="icon svg-icon-ti-ti-folder" xmlns="http://www.w3.org/2000/svg"
                                    width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                    <path
                                        d="M5 4h4l3 3h7a2 2 0 0 1 2 2v8a2 2 0 0 1 -2 2h-14a2 2 0 0 1 -2 -2v-11a2 2 0 0 1 2 -2">
                    ...
                    <li class="nav-item dropdown"><a class="nav-link dropdown-toggle nav-priority-2000" href="{{ url("/") }}/admin#cms-core-appearance" id="cms-core-appearance" data-bs-toggle="dropdown"
                        ...
                        <div class="dropdown-menu animate slideIn dropdown-menu-start"><a
                                ...
                                id="cms-core-menu" title="Menus"><span class="nav-link-icon d-md-none d-lg-inline-block"
                                    title="Menus"><svg class="icon svg-icon-ti-ti-tournament"
                                        xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                        fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                        stroke-linejoin="round">
                                ...
                                id="cms-core-widget" title="Widgets"><span
                                    class="nav-link-icon d-md-none d-lg-inline-block" title="Widgets"><svg
                                        class="icon svg-icon-ti-ti-layout" xmlns="http://www.w3.org/2000/svg" width="24"
                                        height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                        stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                        <path
                                ...
                                class="dropdown-item nav-priority-4" href="{{ url("/") }}/admin/theme/options"
                                id="cms-core-theme-option" title="Theme Options"><span
                                    class="nav-link-icon d-md-none d-lg-inline-block" title="Theme Options"><svg
                                        class="icon svg-icon-ti-ti-list-tree" xmlns="http://www.w3.org/2000/svg"
                                        width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                        stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                        <path d="M9 6h11"></path>
                                ...
                                </span></a><a class="dropdown-item nav-priority-5" href="{{ url("/")
                                }}/admin/theme/custom-css" id="cms-core-appearance-custom-css" title="Custom CSS"><span
                                ...
                                </span></a><a class="dropdown-item nav-priority-6" href="{{ url("/")
                                }}/admin/theme/custom-js" id="cms-core-appearance-custom-js" title="Custom JS"><span
                                ...
                                }}/admin/theme/custom-html" id="cms-core-appearance-custom-html"
                                title="Custom HTML"><span class="nav-link-icon d-md-none d-lg-inline-block"
                                    title="Custom HTML"><svg class="icon svg-icon-ti-ti-file-type-html"
                                        xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                        fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                        stroke-linejoin="round">
                                        <path d="M14 3v4a1 1 0 0 0 1 1h4"></path>
                            ...
                            <a class="dropdown-item nav-priority-6" href="{{ url("/") }}/admin/theme/robots-txt"
                                id="cms-core-appearance-robots-txt" title="Robots.txt Editor">
                                <span class="nav-link-icon d-md-none d-lg-inline-block" title="Robots.txt Editor"><svg
                                        class="icon svg-icon-ti-ti-file-type-txt" xmlns="http://www.w3.org/2000/svg"
                                        width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                        stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                        <path d="M14 3v4a1 1 0 0 0 1 1h4"></path>
                                        <path d="M14 3v4a1 1 0 0 0 1 1h4"></path>
                    ...
                    <li class="nav-item dropdown"><a class="nav-link dropdown-toggle nav-priority-3000" href="{{ url("/") }}/admin#cms-core-plugins" id="cms-core-plugins" data-bs-toggle="dropdown"
                        ...
                        <div class="dropdown-menu animate slideIn dropdown-menu-start"><a
                                class="dropdown-item nav-priority-1" href="{{ url("/") }}/admin/plugins/installed"
                                id="cms-core-plugins-installed" title="Installed Plugins"><span
                                    class="nav-link-icon d-md-none d-lg-inline-block" title="Installed Plugins"><svg
                                        class="icon svg-icon-ti-ti-square-check" xmlns="http://www.w3.org/2000/svg"
                                        width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                        stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                        <path
                                ...
                                </span></a><a class="dropdown-item nav-priority-2" href="{{ url("/")
                                }}/admin/plugins/new" id="cms-core-plugins-marketplace" title="Add New Plugin"><span
                                    class="nav-link-icon d-md-none d-lg-inline-block" title="Add New Plugin"><svg
                                        class="icon svg-icon-ti-ti-square-rounded-plus"
                                        xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                        fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                        stroke-linejoin="round">
                    ...
                    <li class="nav-item dropdown"><a class="nav-link dropdown-toggle nav-priority-9000" href="{{ url("/") }}/admin#cms-core-tools" id="cms-core-tools" data-bs-toggle="dropdown"
                        ...
                        <div class="dropdown-menu animate slideIn dropdown-menu-start"><a
                                class="dropdown-item nav-priority-9000" href="{{ url("/")
                                }}/admin/tools/data-synchronize" id="cms-packages-data-synchronize"
                                title="Export/Import Data"><span class="nav-link-icon d-md-none d-lg-inline-block"
