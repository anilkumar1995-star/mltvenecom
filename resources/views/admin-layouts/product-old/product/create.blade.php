                    ...
                    <main class="page-body page-content">
                        <div class="container-xl">
                            ...
                            <form method="POST" action="https://shofy-grocery.botble.com/admin/ecommerce/products/create"
                                accept-charset="UTF-8" id="botble-ecommerce-forms-product-form"
                                class="js-base-form dirty-check" enctype="multipart/form-data"><input name="_token"
                                    type="hidden" value="T6hUNYEHuiPpoR8AYujAssOGI6mPlZdfSRZyHrnv">
                                ...
                                <div class="row">
                                    <div class="gap-3 col-md-9">
                                            ...
                                            <div class="card-body">
                                                <div class="form-body">
                                                    ...
                                                    <input type="hidden" name="model"
                                                        value="Botble\Ecommerce\Models\Product">
                                                    ...
                                                    <div class="mb-3 ">
                                                        <div class="slug-field-wrapper" data-field-name="name">
                                                            ...
                                                            <div class="slug-data"
                                                                ...
                                                                data-view="https://shofy-grocery.botble.com/products/"
                                                                data-id="0"></div>
                                                    ...
                                                    <div class="mb-3 position-relative">
                                                        ...
                                                        <textarea
                                                            ...
                                                            id="description" name="description" cols="50"></textarea>
                                                    ...
                                                    <div class="mb-3 position-relative">
                                                        ...
                                                        <div class="repeater-group"
                                                            id="repeater_field_59b934d124126a66405adaa4ffa5f7d1_6981e4685c50f_group"
                                                            data-next-index="0">
                                                        </div>

                                                        <div class="mb-3">
                                                            <button class="btn" type="button" data-target="repeater-add"
                                                                data-id="repeater_field_59b934d124126a66405adaa4ffa5f7d1_6981e4685c50f">
                                                    ...
                                                    <input class="form-control" name="product_type" type="hidden"
                                                        value="physical">
                                        ...
                                        <div class="card mb-3 product-specification-table">
                                            <div class="card-header">
                                                ...
                                                <div class="card-actions"><select class="form-select"
                                                        name="specification_table_id" id="specification_table_id">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="mb-3 position-relative">
                                                                ...
                                                                <div class="input-group input-group-flat">
                                                                    ...
                                                                    <input class="form-control input-mask-number"
                                                                        type="text" name="cost_per_item" id="cost_per_item"
                                                                        value="0" placeholder="Enter cost per item"
                                                                        step="any" />
                                                    ...
                                                    <div class="mb-3 position-relative">
                                                        ...
                                                        <label class="form-check">
                                                            <input type="checkbox" name="with_storehouse_management"
                                                                class="form-check-input storehouse-management-status"
                                                                value="1">
                                            ...
                                            <div class="card mb-3">
                                                <div class="card-header">
                                                    ...
                                                    <div class="card-actions"><button
                                                            class="btn   btn-trigger-add-attribute" type="button"
                                                ...
                                                <div class="card-body">
                                                    <div class="add-new-product-attribute-wrap">
                                                        <input id="is_added_attributes" name="is_added_attributes"
                                                            type="hidden" value="0">
                                                        ...
                                                        <fieldset class="form-fieldset list-product-attribute-wrap"
                                                            ...
                                                            <div class="btn-list">
                                                                <button class="btn   btn-trigger-add-attribute-item"
                                                                    style=";" type="button">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col ms-auto ms-md-0 col-12 col-md-8">
                                                                <div
                                                                    ...
                                                                    <button class="btn   add-from-global-option"
                                                                        type="button">
                                            ...
                                            <div class="card meta-boxes mb-3" id="faq_schema_config_wrapper">
                                                ...
                                                <div class="card-body">
                                                        ...
                                                        <div>
                                                            ...
                                                            <div class="mt-2">
                                                                <a href="https://search.google.com/test/rich-results"
                                                                    target="_blank" rel="noopener noreferrer">Test with
                                                    ...
                                                    <div class="faq-schema-items">
                                                        ...
                                                        <div class="repeater-group"
                                                            id="repeater_field_87fbb392676c2e40c750bdd1139f90ef_6981e4686cb09_group"
                                                            data-next-index="0">
                                                        </div>

                                                        <div class="mb-3">
                                                            <button class="btn" type="button" data-target="repeater-add"
                                                                data-id="repeater_field_87fbb392676c2e40c750bdd1139f90ef_6981e4686cb09">
                                                ...
                                                <div class="card-body">
                                                    <div class="seo-preview" v-pre>
                                                        ...
                                                        <div class="existed-seo-meta hidden">
                                                            ...
                                                            <div>
                                                                <span style="color: #70757a;">Feb 03, 2026
                                                                    - </span>
                                                    ...
                                                    <div class="hidden seo-edit-section" v-pre>
                                                        ...
                                                        <div class="mb-3 position-relative">
                                                            ...
                                                            <div class="position-relative form-check-group">
                                                                ...
                                                                <label class="form-check form-check-inline">
                                                                    <input class="form-check-input"
                                                                        id="seo_meta[index]_index_noindex" type="radio"
                                    ...
                                    <div class="col-md-3 gap-3 d-flex flex-column-reverse flex-md-column mb-md-0 mb-5">
                                        ...
                                        <div class="card meta-boxes">
                                            ...
                                            <div class=" card-body">
                                                <select class="form-select" required="required" id="status-select-33762"
                                                    name="status">
                                        ...
                                        <div class="card meta-boxes">
                                            ...
                                            <div class=" card-body">
                                                <select class="select-search-full form-select"
                                                    ...
                                                    id="store_id-select-79138" name="store_id">
                                            ...
                                            <div class=" card-body">
                                                <div class="mb-3">
                                                    <div class="input-icon">
                                                        <input type="text" id="search-category-input-998471405"
                                                            class="form-control" placeholder="Search..."
                                                            onkeyup="filter_categories_998471405(998471405)"
                                                            formnovalidate />
                                                ...
                                                <div data-bb-toggle="tree-checkboxes"
                                                    class="tree-categories-list-998471405">
                                                ...
                                                <script>
                                                    function filter_categories_998471405(inputSearchId) {
                                        ...
                                        <div class="card meta-boxes">
                                            ...
                                            <div class=" card-body">
                                                <select class="select-search-full form-select"
                                                    ...
                                                    id="brand_id-select-42140" name="brand_id">
                                        ...
                                        <div class="card meta-boxes">
                                            ...
                                            <div class=" card-body">
                                                <div class="image-box image-box-image" action="select-image"
                                                    data-counter="250">
                                                    <input class="image-data" name="image" type="hidden" value="" class=""
                                                        data-counter="250" />
