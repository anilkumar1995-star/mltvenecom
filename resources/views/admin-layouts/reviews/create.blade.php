                        ...
                        <div class="card mb-3">
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <input type="hidden" name="product_id" id="product-id" required>
                                    ...
                                    <div id="selected-product" class="mt-2 text-primary font-weight-bold"></div>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div id="selected-customer" class="mt-2 text-primary font-weight-bold"></div>
                                ...
                                <div class="p-3 bg-light border rounded mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="customer_name" placeholder="Customer name" data-counter="250">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label required">Customer email</label>
                                        <input type="email" class="form-control" name="customer_email" placeholder="Customer email" data-counter="60">
                                    </div>
                                </div>
                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                <div class="input-icon">
                                    ...
                                    <input class="form-control form-date-time" name="created_at" type="text" value="{{ now()->format('Y-m-d H:i:s') }}" data-date-format="YYYY-MM-DD HH:mm:ss">
                                </div>
                            </div>
                        </div>
