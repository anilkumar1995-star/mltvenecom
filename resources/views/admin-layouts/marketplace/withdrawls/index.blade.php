...
@section('title', 'Marketplace Withdrawls')
@section('content')
                                    ...
                                    <div class="wrapper-filter">
                                        ...
                                        <form method="GET" action="https://shofy-grocery.botble.com/admin/marketplaces/withdrawals" accept-charset="UTF-8" class="filter-form">
                                            ...
                                            <div class="btn-list">
                                                ...
                                                <a
                                                    class="btn btn-icon   w-6" style="display: none;" type="button" href="https://shofy-grocery.botble.com/admin/marketplaces/withdrawals" data-bb-toggle="datatable-reset-filter">
                            ...
                            <div class="card has-actions has-filter">
                                            ...
                                            <div class="dropdown d-inline-block">
                                                ...
                                                <div class="dropdown-menu">
                                                    <div class="dropdown-submenu">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <button class="dropdown-item bulk-change-item" data-key="status" data-class-item="Botble\Marketplace\Tables\WithdrawalTable" data-save-url="https://shofy-grocery.botble.com/admin/tables/bulk-changes/save">
                                ...
                                <div class="card-table">
                                    <div class="table-responsive table-has-actions table-has-filter">
                                        <table class="table card-table table-vcenter table-striped table-hover" id="botble-marketplace-tables-withdrawal-table">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th title="Vendor" class="text-start  column-key-1">Vendor</th>
                                                    <th title="Amount" class=" column-key-2">Amount</th>
                                                    <th title="Fee" class=" column-key-3">Fee</th>
