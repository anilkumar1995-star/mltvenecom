                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li
                                    ...
                                    aria-current="page">
                                    <h1 class="mb-0 d-inline-block fs-6 lh-1">Edit store</h1>
                                </li>
                            </ol>
                        </nav>
                ...
                <div class="card-body">
                    <div class="tab-content">
                        <div class="tab-pane active show" id="information-tab">
                            <form method="POST" action="{{ route('admin.marketplace.store.update', $store->id) }}" accept-charset="UTF-8" id="store-form" class="js-base-form dirty-check" enctype="multipart/form-data">
                                @method('PUT')
                        ...
                        <div class="row row-cols-lg-6">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="mb-3 position-relative shop-url-wrapper">
                                            ...
                                            <input
                                                class="form-control" style="direction: ltr; text-align: left;" type="text" name="slug" id="shop-url" value="{{ old('slug', $store->slug) }}" required="required" data-url="{{ url('/ajax/stores/check-store-url') }}" placeholder="Shop URL" dir="ltr" />
                            ...
                            <div class="col-lg-12">
                                <div class="mb-3 position-relative">
                                    ...
                                    <textarea class="form-control" data-counter="400" rows="4" placeholder="Short description" id="description" name="description" cols="50">{{ old('description', $store->description) }}</textarea>
                            ...
                            <div class="col-lg-12">
                                <div class="mb-3 position-relative">
                                    ...
                                    <textarea class="form-control form-control editor-ckeditor ays-ignore" data-counter="100000" rows="4" placeholder="Write your content" id="content" name="content" cols="50">{{ old('content', $store->content) }}</textarea>
                                ...
                                <div class="mb-3 position-relative">
                                    ...
                                    <select class="form-select" data-type="country" id="country-select-59605" name="country">
                                        ...
                                        <option value="{{ $country->code }}"
                                            {{ old('country', $store->country) == $country->code ? 'selected' : '' }}>
                                            {{ $country->name }}
                                        </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3 position-relative">
                                    ...
                                    <input class="form-control" data-counter="250" value="{{ old('state', $store->state) }}" placeholder="Select state..." name="state" type="text" id="state">
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3 position-relative">
                                    ...
                                    <input class="form-control" data-counter="250" value="{{ old('city', $store->city) }}" placeholder="Select city..." name="city" type="text" id="city">
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3 position-relative">
                                    ...
                                    <input class="form-control" data-counter="250" value="{{ old('address', $store->address) }}" placeholder="Enter address" name="address" type="text" id="address">
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3 position-relative">
                                    ...
                                    <input class="form-control" data-counter="255" value="{{ old('company', $store->company) }}" placeholder="Company" name="company" type="text" id="company">
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3 position-relative">
                                    ...
                                    <input class="form-control" data-counter="255" value="{{ old('tax_id', $store->tax_id) }}" name="tax_id" type="text" id="tax_id">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input class="form-control" placeholder="{username}" id="social_links_facebook" name="social_links[facebook]" type="text" value="{{ old('social_links.facebook', $store->social_links['facebook'] ?? '') }}">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input class="form-control" placeholder="{username}" id="social_links_twitter" name="social_links[twitter]" type="text" value="{{ old('social_links.twitter', $store->social_links['twitter'] ?? '') }}">
                                                <span class="input-group-text">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input class="form-control" placeholder="{username}" id="social_links_instagram" name="social_links[instagram]" type="text" value="{{ old('social_links.instagram', $store->social_links['instagram'] ?? '') }}">
                                                <span class="input-group-text">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input class="form-control" placeholder="{username}" id="social_links_youtube" name="social_links[youtube]" type="text" value="{{ old('social_links.youtube', $store->social_links['youtube'] ?? '') }}">
                                                <span class="input-group-text">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input class="form-control" placeholder="{username}" id="social_links_linkedin" name="social_links[linkedin]" type="text" value="{{ old('social_links.linkedin', $store->social_links['linkedin'] ?? '') }}">
                                                <span class="input-group-text">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group mb-3">
                                                <input class="form-control" placeholder="Ex: https://whatsapp.com/{username}" id="social_links_whatsapp" name="social_links[whatsapp]" type="text" value="{{ old('social_links.whatsapp', $store->social_links['whatsapp'] ?? '') }}">
                                                <span class="input-group-text">
                                ...
                                <div class="card-body">
                                    ...
                                    <div
                                        ...
                                        <div class="mb-3 position-relative">
                                            ...
                                            <input class="form-control" data-counter="70" placeholder="SEO Title" data-allow-over-limit name="seo_meta[seo_title]" type="text" id="seo_meta[seo_title]" value="{{ old('seo_meta.seo_title', $store->seo_meta['seo_title'] ?? '') }}">
                                        ...
                                        <div class="mb-3 position-relative">
                                            ...
                                            <textarea class="form-control" data-counter="160" rows="3" placeholder="SEO description" data-allow-over-limit id="seo_meta[seo_description]" name="seo_meta[seo_description]" cols="50">{{ old('seo_meta.seo_description', $store->seo_meta['seo_description'] ?? '') }}</textarea>
                                                    ...
                                                    <div class="preview-image-inner">
                                                        <a href="javascript:void(0)" onclick="$('#seo-meta-image-input').trigger('click')" class="image-box-actions">
                                                            <img class="preview-seo-meta-image preview-image default-image"
                                                                data-default="{{ asset('images/placeholder.png') }}"
                                                                src="{{ (isset($store->seo_meta['seo_image']) && $store->seo_meta['seo_image']) ? asset($store->seo_meta['seo_image']) : asset('images/placeholder.png') }}"
                                                                alt="Preview image" style="width: 8rem; height: 8rem; object-fit: cover;" />
                                                            <span class="image-picker-backdrop"></span>
                                                        </a>
                                            ...
                                            <div class="position-relative form-check-group">
                                                ...
                                                <label class="form-check form-check-inline">
                                                    <input
                                                        ...
                                                        name="seo_meta[index]"
                                                        value="index"
                                                        {{ (isset($store->seo_meta['index']) && $store->seo_meta['index'] == 'index') ? 'checked' : '' }}>
                                                ...
                                                <label class="form-check form-check-inline">
                                                    <input
                                                        ...
                                                        name="seo_meta[index]"
                                                        value="noindex"
                                                        {{ (isset($store->seo_meta['index']) && $store->seo_meta['index'] == 'noindex') ? 'checked' : '' }}>
