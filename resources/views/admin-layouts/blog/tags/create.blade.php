...
<div class="page-wrapper">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">
                                    <h1 class="mb-0 d-inline-block fs-6 lh-1 font-medium">Create a new tag</h1>
                                </li>
                            </ol>
                        </nav>
                    </div>
    ...
    <main class="page-body page-content">
        <div class="container-fluid">
            <form action="{{ route('admin.blog.tags.store') }}" method="POST" id="tag-form" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    {{-- Main Content --}}
                    <div class="col-md-9">
                        ...
                        <div class="card mb-3 shadow-sm">
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="name" id="name" value="{{ old('name') }}" placeholder="Name" required maxlength="120">
                                </div>
                                <div class="mb-3">
                                    ...
                                    <div class="input-group mb-1 shadow-sm">
                                        ...
                                        <input type="text" class="form-control border-start-0 ps-0" name="slug" id="slug" value="{{ old('slug') }}" placeholder="slug" readonly>
                                    ...
                                    <small class="form-hint mt-1">Preview: <a href="#" target="_blank" id="slug-preview" class="text-primary text-decoration-none border-bottom border-primary border-opacity-25">{{ url('tag') }}/</a></small>
                                </div>
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control editor" name="description" id="content-editor" rows="10" placeholder="Short description">{{ old('description') }}</textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card mb-3 shadow-sm">
                            ...
                            <div class="card-body px-4 pb-4">
                                ...
                                <div id="seo-content" class="mt-4" style="display: none;">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="seo_title" id="seo_title" value="{{ old('seo_title') }}" placeholder="SEO Title">
                                        <small class="text-muted mt-1 d-block">Character count: <span id="seo_title_count">0</span> / 70. Optimal length: 50-70 characters.</small>
                                    </div>
                                    <div class="mb-3">
                                        ...
                                        <small class="text-muted mt-1 d-block">Character count: <span id="seo_desc_count">0</span> / 160. Optimal length: 150-160 characters.</small>
                                    </div>
                                    <div class="mb-3">
                                        ...
                                        <div class="image-preview-container p-3 bg-light rounded-3 d-flex align-items-center justify-content-center cursor-pointer border-2 border-dashed" style="min-height: 120px;" onclick="document.getElementById('seo_image_input').click();">
                                            ...
                                            <img id="seo-image-preview" src="#" alt="Preview" style="max-width: 100%; max-height: 150px; display: none;" class="rounded shadow-sm">
                                        </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#toggle-editor').on('click', function() {
            if (editor) {
                // CKEditor 5 doesn't easily 'destroy' and 'replace' in place like CKEditor 4
                // Usually we just leave it or use a simpler hidden/visible logic
                // But for parity, if they want to 'Hide Editor', we can hide the container
                $('.ck-editor').toggle();
