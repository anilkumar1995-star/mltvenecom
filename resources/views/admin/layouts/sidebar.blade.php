 <aside class="navbar navbar-vertical navbar-expand-lg flex-auto" data-bs-theme="dark"
                ...
                <div class="container-xl"><button class="navbar-toggler" type="button" data-bs-toggle="collapse"
                    ...
                    <h2 class="d-block d-lg-none navbar-brand navbar-brand-autodark"><a
                            href="{{asset('/')}}admin"><img
                                src="./Admin Dashboard _ Your App_files/logo-white.png" alt="Your App"
                                class="navbar-brand-image" style="max-height: 32px; height: auto;"></a></h2>
                    <div class="navbar-nav flex-row d-lg-none">
                        <div class="dropdown nav-item"><a href="{{asset('/')}}admin#"
                                ...
                                <div class="d-none d-xl-block ps-2">
                                    <div>Sunil Kumar</div>
                                    <div class="mt-1 small text-muted">sunil@ipayments.org.in</div>
                                </div>
                            </a>
                            <div class="dropdown-menu dropdown-menu-arrow dropdown-menu-end"><a class="dropdown-item"
                                    href="{{asset('/')}}admin/system/users/profile/1"><svg
                                        class="icon dropdown-item-icon svg-icon-ti-ti-user"
                                    ...
                                    href="{{asset('/')}}admin/logout"><svg
                                        class="icon dropdown-item-icon svg-icon-ti-ti-logout"
                                        xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                        fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                        stroke-linejoin="round">
                                        <path
                    ...
                    <div class="collapse navbar-collapse" id="sidebar-menu">
                        <ul class="navbar-nav">
                                ...
                                <div class="dropdown-menu animate slideIn dropdown-menu-start"><a
                                        ...
                                        id="cms-plugins-ecommerce-report" title="Report"><span
                                            class="nav-link-icon d-md-none d-lg-inline-block" title="Report"><svg
                                                class="icon svg-icon-ti-ti-report-analytics"
                                        ...
                                        id="cms-plugins-ecommerce-order" title="Orders"><span
                                            class="nav-link-icon d-md-none d-lg-inline-block" title="Orders"><svg
                                                class="icon svg-icon-ti-ti-truck-delivery"
                                                xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                                stroke-linecap="round" stroke-linejoin="round">
                                        ...
                                        id="cms-plugins-ecommerce-incomplete-order" title="Incomplete orders"><span
                                            ...
                                            title="Incomplete orders"><svg class="icon svg-icon-ti-ti-basket-cancel"
                                                xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                                stroke-linecap="round" stroke-linejoin="round">
                                        ...
                                        id="cms-plugins-ecommerce-order-return" title="Order returns"><span
                                            class="nav-link-icon d-md-none d-lg-inline-block" title="Order returns"><svg
                                                class="icon svg-icon-ti-ti-basket-down"
                                                xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                                stroke-linecap="round" stroke-linejoin="round">
                                                <path d="M17 10l-2 -6"></path>
                                        ...
                                        id="cms-plugins-ecommerce-shipping-shipments" title="Shipments"><span
                                            class="nav-link-icon d-md-none d-lg-inline-block" title="Shipments"><svg
                                                class="icon svg-icon-ti-ti-truck-loading"
                                                xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                                stroke-linecap="round" stroke-linejoin="round">
                                        ...
                                        id="cms-plugins-ecommerce-invoice" title="Invoices"><span
                                            class="nav-link-icon d-md-none d-lg-inline-block" title="Invoices"><svg
                                                class="icon svg-icon-ti-ti-file-invoice"
                                                xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                                stroke-linecap="round" stroke-linejoin="round">
                                        ...
                                        id="cms-plugins-ecommerce-product" title="Products"><span
                                            ...
                                            </svg></span><span class="nav-link-title text-truncate"> Products <span
                                        ...
                                        id="cms-plugins-ecommerce-product-price" title="Product Prices"><span
                                            class="nav-link-icon d-md-none d-lg-inline-block"
                                            title="Product Prices"><svg class="icon svg-icon-ti-ti-currency-dollar"
                                                xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                                stroke-linecap="round" stroke-linejoin="round">
                                                <path
                                        ...
                                        id="cms-plugins-ecommerce-product-inventory" title="Product Inventory"><span
                                            class="nav-link-icon d-md-none d-lg-inline-block"
                                            title="Product Inventory"><svg class="icon svg-icon-ti-ti-home-check"
                                                xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                                stroke-linecap="round" stroke-linejoin="round">
                                        ...
                                        id="cms-plugins-product-categories" title="Product categories"><span
                                            class="nav-link-icon d-md-none d-lg-inline-block"
                                            title="Product categories"><svg class="icon svg-icon-ti-ti-archive"
                                                xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                                stroke-linecap="round" stroke-linejoin="round">
                                                <path
                                        ...
                                        id="cms-plugins-product-tag" title="Product tags"><span
                                            class="nav-link-icon d-md-none d-lg-inline-block" title="Product tags"><svg
                                                class="icon svg-icon-ti-ti-tag" xmlns="http://www.w3.org/2000/svg"
                                                width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                                stroke-linejoin="round">
                                        ...
                                        id="cms-plugins-flash-sale" title="Flash sales"><span
                                            class="nav-link-icon d-md-none d-lg-inline-block" title="Flash sales"><svg
                                                class="icon svg-icon-ti-ti-bolt" xmlns="http://www.w3.org/2000/svg"
                                                width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                                stroke-linejoin="round">
                                        ...
                                        title="Customers"><span class="nav-link-icon d-md-none d-lg-inline-block"
                                            ...
                                            </svg></span><span class="nav-link-title text-truncate"> Customers
                                        </span></a></div>
                            </li>
                            <li class="nav-item dropdown"><a class="nav-link dropdown-toggle nav-priority-0"
                                    href="{{asset('/')}}admin#cms-plugins-product-specification"
                                    id="cms-plugins-product-specification" data-bs-toggle="dropdown"
                                    data-bs-auto-close="false" role="button" aria-expanded="false"
                                    title="Product Specification"><span
                                        class="nav-link-icon d-md-none d-lg-inline-block"
                                ...
                                <div class="dropdown-menu animate slideIn dropdown-menu-start"><a
                                        class="dropdown-item nav-priority-0"
                                        href="{{asset('/')}}admin/ecommerce/specification-groups"
                                        id="cms-plugins-product-specification-groups" title="Groups"><span
                                            ...
                                            </svg></span><span class="nav-link-title text-truncate"> Groups
                                        </span></a><a class="dropdown-item nav-priority-10"
                                        href="{{asset('/')}}admin/ecommerce/specification-attributes"
                                        id="cms-plugins-product-specification-attributes" title="Attributes"><span
                                            class="nav-link-icon d-md-none d-lg-inline-block" title="Attributes"><svg
                                                class="icon svg-icon-ti-ti-list-details"
                                                xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                                stroke-linecap="round" stroke-linejoin="round">
                                                <path d="M13 5h8"></path>
                                        ...
                                        href="{{asset('/')}}admin/ecommerce/specification-tables"
                            ...
                            <li class="nav-item dropdown"><a class="nav-link dropdown-toggle nav-priority-0"
                                    href="{{asset('/')}}admin#cms-plugins-marketplace"
                                    id="cms-plugins-marketplace" data-bs-toggle="dropdown" data-bs-auto-close="false"
                                ...
                                <div class="dropdown-menu animate slideIn dropdown-menu-start"><a
                                        class="dropdown-item nav-priority-0"
                                        href="{{asset('/')}}admin/marketplaces/reports"
                                        ...
                                        href="{{asset('/')}}admin/marketplaces/stores" id="cms-plugins-store"
                                        ...
                                        href="{{asset('/')}}admin/marketplaces/vendors"
                                        id="cms-plugins-marketplace-vendors" title="Vendors"><span
                                            class="nav-link-icon d-md-none d-lg-inline-block" title="Vendors"><svg
                                                ...
                                                <path d="M16 3.13a4 4 0 0 1 0 7.75"></path>
                                                <path d="M21 21v-2a4 4 0 0 0 -3 -3.85"></path>
                                            </svg></span><span class="nav-link-title text-truncate"> Vendors
                                        </span></a><a class="dropdown-item nav-priority-5"
                                        href="{{asset('/')}}admin/marketplaces/unverified-vendors"
                                        id="cms-plugins-marketplace-unverified-vendor" title="Unverified vendors"><span
                                            class="nav-link-icon d-md-none d-lg-inline-block"
                                            title="Unverified vendors"><svg class="icon svg-icon-ti-ti-user-question"
                                                xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                                stroke-linecap="round" stroke-linejoin="round">
                                                <path d="M8 7a4 4 0 1 0 8 0a4 4 0 0 0 -8 0"></path>
                                        ...
                                        href="{{asset('/')}}admin/marketplaces/messages"
                                        id="cms-plugins-marketplace-messages" title="Messages"><span
                                            ...
                                            </svg></span><span class="nav-link-title text-truncate"> Messages
                                        </span></a></div>
                            </li>
                            <li class="nav-item"><a class="nav-link nav-priority-2"
                                    href="{{asset('/')}}admin/pages" id="cms-core-page" title="Pages"><span
                                        class="nav-link-icon d-md-none d-lg-inline-block" title="Pages"><svg
                                            class="icon svg-icon-ti-ti-notebook" xmlns="http://www.w3.org/2000/svg"
                                            width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                            stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                            <path
                            ...
                            <li class="nav-item dropdown"><a class="nav-link dropdown-toggle nav-priority-3"
                                    href="{{asset('/')}}admin#cms-plugins-blog" id="cms-plugins-blog"
                                    data-bs-toggle="dropdown" data-bs-auto-close="false" role="button"
                                ...
                                <div class="dropdown-menu animate slideIn dropdown-menu-start"><a
                                        class="dropdown-item nav-priority-10"
                                        href="{{asset('/')}}admin/blog/posts" id="cms-plugins-blog-post"
                                        title="Posts"><span class="nav-link-icon d-md-none d-lg-inline-block"
                                            title="Posts"><svg class="icon svg-icon-ti-ti-file-text"
                                                xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                                stroke-linecap="round" stroke-linejoin="round">
                                                <path d="M14 3v4a1 1 0 0 0 1 1h4"></path>
                                        ...
                                        class="dropdown-item nav-priority-20"
                                        href="{{asset('/')}}admin/blog/categories"
                                        ...
                                        href="{{asset('/')}}admin/blog/tags" id="cms-plugins-blog-tags"
                                        ...
                                        class="dropdown-item nav-priority-40"
                                        href="{{asset('/')}}admin/blog/reports" id="cms-plugins-blog-reports"
                                        title="Reports"><span class="nav-link-icon d-md-none d-lg-inline-block"
                                            title="Reports"><svg class="icon svg-icon-ti-ti-chart-bar"
                                                xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                                stroke-linecap="round" stroke-linejoin="round">
                                                <path
                            ...
                            <li class="nav-item dropdown"><a class="nav-link dropdown-toggle nav-priority-3"
                                    href="{{asset('/')}}admin#cms-plugins-payments" id="cms-plugins-payments"
                                    data-bs-toggle="dropdown" data-bs-auto-close="false" role="button"
                                ...
                                <div class="dropdown-menu animate slideIn dropdown-menu-start"><a
                                        class="dropdown-item nav-priority-0"
                                        href="{{asset('/')}}admin/payments/transactions"
                                        id="cms-plugins-payments-all" title="Transactions"><span
                                            class="nav-link-icon d-md-none d-lg-inline-block" title="Transactions"><svg
                                        ...
                                        href="{{asset('/')}}admin/payments/logs" id="cms-plugins-payment-logs"
                                        title="Payment Logs"><span class="nav-link-icon d-md-none d-lg-inline-block"
                                            title="Payment Logs"><svg class="icon svg-icon-ti-ti-file-text"
                                                xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                                stroke-linecap="round" stroke-linejoin="round">
                                                <path d="M14 3v4a1 1 0 0 0 1 1h4"></path>
                                        ...
                                        href="{{asset('/')}}admin/payments/methods"
                                        id="cms-plugins-payment-methods" title="Payment methods"><span
                                            class="nav-link-icon d-md-none d-lg-inline-block"
                                            title="Payment methods"><svg class="icon svg-icon-ti-ti-settings"
                                                xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                                stroke-linecap="round" stroke-linejoin="round">
                                                <path
                            ...
                            <li class="nav-item"><a class="nav-link nav-priority-5"
                                    href="{{asset('/')}}admin/galleries" id="cms-plugins-gallery"
                            ...
                            <li class="nav-item"><a class="nav-link nav-priority-5"
                                    href="{{asset('/')}}admin/testimonials" id="cms-plugins-testimonial"
                                    title="Testimonials"><span class="nav-link-icon d-md-none d-lg-inline-block"
                                        ...
                                        </svg></span><span class="nav-link-title text-truncate"> Testimonials
                                    </span></a></li>
                            <li class="nav-item dropdown"><a class="nav-link dropdown-toggle nav-priority-8"
                                    href="{{asset('/')}}admin#cms-plugins-ads" id="cms-plugins-ads"
                                    data-bs-toggle="dropdown" data-bs-auto-close="false" role="button"
                                ...
                                <div class="dropdown-menu animate slideIn dropdown-menu-start"><a
                                        class="dropdown-item nav-priority-1" href="{{asset('/')}}admin/ads"
                                        ...
                                        href="{{asset('/')}}admin/settings/ads" id="cms-plugins-ads-setting"
                                        title="Ads Settings"><span class="nav-link-icon d-md-none d-lg-inline-block"
                                            title="Ads Settings"><svg class="icon svg-icon-ti-ti-settings"
                                                xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                                stroke-linecap="round" stroke-linejoin="round">
                                                <path
                            ...
                            <li class="nav-item"><a class="nav-link nav-priority-10"
                                    href="{{asset('/')}}admin/announcements" id="cms-plugins-announcement"
                                    title="Announcements"><span class="nav-link-icon d-md-none d-lg-inline-block"
                                        ...
                                        </svg></span><span class="nav-link-title text-truncate"> Announcements
                                    </span></a></li>
                            <li class="nav-item dropdown"><a class="nav-link dropdown-toggle nav-priority-120"
                                    href="{{asset('/')}}admin#cms-plugins-contact" id="cms-plugins-contact"
                                    data-bs-toggle="dropdown" data-bs-auto-close="false" role="button"
                                    aria-expanded="false" title="Contact"><span
                                        class="nav-link-icon d-md-none d-lg-inline-block" title="Contact"><svg
                                            ...
                                            style="">5</span></span></a>
                                <div class="dropdown-menu animate slideIn dropdown-menu-start"><a
                                        class="dropdown-item nav-priority-120"
                                        href="{{asset('/')}}admin/contacts" id="cms-plugins-contact-list"
                                        title="Contacts"><span class="nav-link-icon d-md-none d-lg-inline-block"
                                            title="Contacts"><svg class="icon svg-icon-ti-ti-cube"
                                                xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                                stroke-linecap="round" stroke-linejoin="round">
                                                <path
                                        ...
                                        href="{{asset('/')}}admin/contacts/custom-fields"
                            ...
                            <li class="nav-item"><a class="nav-link nav-priority-390"
                                    href="{{asset('/')}}admin/simple-sliders" id="cms-plugins-simple-slider"
                            ...
                            <li class="nav-item dropdown"><a class="nav-link dropdown-toggle nav-priority-420"
                                    href="{{asset('/')}}admin#cms-plugins-faq" id="cms-plugins-faq"
                                    data-bs-toggle="dropdown" data-bs-auto-close="false" role="button"
                                ...
                                <div class="dropdown-menu animate slideIn dropdown-menu-start"><a
                                        class="dropdown-item nav-priority-0" href="{{asset('/')}}admin/faqs"
                                        id="cms-plugins-faq-list" title="FAQs"><span
                                            class="nav-link-icon d-md-none d-lg-inline-block" title="FAQs"><svg
                                                class="icon svg-icon-ti-ti-list-check"
                                                xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                                stroke-linecap="round" stroke-linejoin="round">
                                        ...
                                        class="dropdown-item nav-priority-10"
                                        href="{{asset('/')}}admin/faq-categories" id="cms-plugins-faq-category"
                            ...
                            <li class="nav-item"><a class="nav-link nav-priority-430"
                                    href="{{asset('/')}}admin/newsletters" id="cms-plugins-newsletter"
                            ...
                            <li class="nav-item dropdown"><a class="nav-link dropdown-toggle nav-priority-900"
                                    href="{{asset('/')}}admin#cms-plugins-location" id="cms-plugins-location"
                                    data-bs-toggle="dropdown" data-bs-auto-close="false" role="button"
                                ...
                                <div class="dropdown-menu animate slideIn dropdown-menu-start"><a
                                        class="dropdown-item nav-priority-0"
                                        href="{{asset('/')}}admin/countries" id="cms-plugins-country"
                                        title="Countries"><span class="nav-link-icon d-md-none d-lg-inline-block"
                                            title="Countries"><svg class="icon svg-icon-ti-ti-flag"
                                                xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                                stroke-linecap="round" stroke-linejoin="round">
                                                <path
                                        ...
                                        href="{{asset('/')}}admin/states" id="cms-plugins-state"
                                        title="States"><span class="nav-link-icon d-md-none d-lg-inline-block"
                                            ...
                                            </svg></span><span class="nav-link-title text-truncate"> States
                                        </span></a><a class="dropdown-item nav-priority-20"
                                        href="{{asset('/')}}admin/cities" id="cms-plugins-city"
                                        title="Cities"><span class="nav-link-icon d-md-none d-lg-inline-block"
                                            title="Cities"><svg class="icon svg-icon-ti-ti-location-pin"
                                                xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                                stroke-linecap="round" stroke-linejoin="round">
                                            ...
                                            </svg></span><span class="nav-link-title text-truncate"> Cities
                                        </span></a><a class="dropdown-item nav-priority-30"
                                        href="{{asset('/')}}admin/locations/bulk-import"
                                        id="cms-plugins-location-bulk-import" title="Location Importer"><span
                                            class="nav-link-icon d-md-none d-lg-inline-block"
                                            title="Location Importer"><svg class="icon svg-icon-ti-ti-package-import"
                                                xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                                stroke-linecap="round" stroke-linejoin="round">
                                        ...
                                        href="{{asset('/')}}admin/locations/export"
                                        id="cms-plugins-location-export" title="Location Exporter"><span
                                            class="nav-link-icon d-md-none d-lg-inline-block"
                            ...
                            <li class="nav-item"><a class="nav-link nav-priority-999"
                                    href="{{asset('/')}}admin/media" id="cms-core-media" title="Media"><span
                            ...
                            <li class="nav-item dropdown"><a class="nav-link dropdown-toggle nav-priority-2000"
                                    href="{{asset('/')}}admin#cms-core-appearance" id="cms-core-appearance"
                                    data-bs-toggle="dropdown" data-bs-auto-close="false" role="button"
                                ...
                                <div class="dropdown-menu animate slideIn dropdown-menu-start"><a
                                        class="dropdown-item nav-priority-1"
                                        href="{{asset('/')}}admin/theme/all" id="cms-core-theme"
                                        title="Themes"><span class="nav-link-icon d-md-none d-lg-inline-block"
                                            title="Themes"><svg class="icon svg-icon-ti-ti-palette"
                                                xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                                stroke-linecap="round" stroke-linejoin="round">
                                                <path
                                            ...
                                            </svg></span><span class="nav-link-title text-truncate"> Themes
                                        </span></a><a class="dropdown-item nav-priority-2"
                                        href="{{asset('/')}}admin/menus" id="cms-core-menu" title="Menus"><span
                                            class="nav-link-icon d-md-none d-lg-inline-block" title="Menus"><svg
                                                class="icon svg-icon-ti-ti-tournament"
                                                xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                                stroke-linecap="round" stroke-linejoin="round">
                                        ...
                                        class="dropdown-item nav-priority-3" href="{{asset('/')}}admin/widgets"
                                        id="cms-core-widget" title="Widgets"><span
                                            ...
                                            </svg></span><span class="nav-link-title text-truncate"> Widgets
                                        </span></a><a class="dropdown-item nav-priority-4"
                                        href="{{asset('/')}}admin/theme/options" id="cms-core-theme-option"
                                        ...
                                        href="{{asset('/')}}admin/theme/custom-css"
                                        id="cms-core-appearance-custom-css" title="Custom CSS"><span
                                            class="nav-link-icon d-md-none d-lg-inline-block" title="Custom CSS"><svg
                                                class="icon svg-icon-ti-ti-file-type-css"
                                                xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                                stroke-linecap="round" stroke-linejoin="round">
                                                <path d="M14 3v4a1 1 0 0 0 1 1h4"></path>
                                        ...
                                        href="{{asset('/')}}admin/theme/custom-html"
                                        ...
                                        href="{{asset('/')}}admin/theme/robots-txt"
                                        id="cms-core-appearance-robots-txt" title="Robots.txt Editor"><span
                                            class="nav-link-icon d-md-none d-lg-inline-block"
                            ...
                            <li class="nav-item dropdown"><a class="nav-link dropdown-toggle nav-priority-3000"
                                    href="{{asset('/')}}admin#cms-core-plugins" id="cms-core-plugins"
                                    data-bs-toggle="dropdown" data-bs-auto-close="false" role="button"
                                ...
                                <div class="dropdown-menu animate slideIn dropdown-menu-start"><a
                                        class="dropdown-item nav-priority-1"
                                        href="{{asset('/')}}admin/plugins/installed"
                                        id="cms-core-plugins-installed" title="Installed Plugins"><span
                                            class="nav-link-icon d-md-none d-lg-inline-block"
                                        ...
                                        href="{{asset('/')}}admin/plugins/new" id="cms-core-plugins-marketplace"
                            ...
                            <li class="nav-item dropdown"><a class="nav-link dropdown-toggle nav-priority-9000"
                                    href="{{asset('/')}}admin#cms-core-tools" id="cms-core-tools"
                                    data-bs-toggle="dropdown" data-bs-auto-close="false" role="button"
                                ...
                                <div class="dropdown-menu animate slideIn dropdown-menu-start"><a
                                        ...
                                        href="{{asset('/')}}admin/tools/data-synchronize"
                            ...
                            <li class="nav-item"><a class="nav-link nav-priority-9999"
                                    href="{{asset('/')}}admin/settings" id="cms-core-settings"
                                    title="Settings"><span class="nav-link-icon d-md-none d-lg-inline-block"
                                        title="Settings"><svg class="icon svg-icon-ti-ti-settings"
                                            ...
                                            <path d="M9 12a3 3 0 1 0 6 0a3 3 0 0 0 -6 0"></path>
                                        </svg></span><span class="nav-link-title text-truncate"> Settings </span></a>
                            </li>
                            <li class="nav-item"><a class="nav-link nav-priority-10000"
                                    href="{{asset('/')}}admin/system" id="cms-core-system"
                                    title="Platform Administration"><span
                                        class="nav-link-icon d-md-none d-lg-inline-block"
