                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-3 gap-3 d-flex flex-column mb-md-0 mb-5">
                            <div class="sticky-top" style="top: 2rem; z-index: 50;">
                                ...
                                <div class="card shadow-sm border-0 border-start border-3 border-purple mb-3">
                                    <div class="card-header py-2 bg-white shadow-none">
                                ...
                                <div class="card shadow-sm border-0 border-top border-3 border-danger">
                                    ...
                                    <div class="card-body p-3">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" name="minimum_order_quantity" class="form-control form-control-sm border-0 bg-light-subtle fw-bold" value="{{ old('minimum_order_quantity', $product->minimum_order_quantity ?? 1) }}" min="1">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="number" name="maximum_order_quantity" class="form-control form-control-sm border-0 bg-light-subtle fw-bold" value="{{ old('maximum_order_quantity', $product->maximum_order_quantity ?? 0) }}" min="0">
