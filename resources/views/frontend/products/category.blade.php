                                        ...
                                        <div class="row mb-30 row-cols-xxl-3 row-cols-md-2 row-cols-sm-2 row-cols-2">
                                            ...
                                            <div class="col">
                                                <div class="tp-product-item-5 p-relative white-bg mb-40 ">
                                                    <div class="tp-product-thumb-5 w-img fix mb-15"><a href="{{ route('frontend.products.show', $product->slug) }}">
                                                            @if($product->image)
                                                        ...
                                                        <div class="tp-product-action-2 tp-product-action-5 tp-product-action-greenStyle">
                                                            <div class="tp-product-action-item-2 d-flex flex-column">
                                                                <a href="{{ route('frontend.products.show', $product->slug) }}" class="tp-product-action-btn-2 tp-product-quick-view-btn" title="Quick View">
                                                    ...
                                                    <div class="tp-product-content-5">
                                                        ...
                                                        <h3 class="tp-product-title-2 line-clamp-2">
                                                            <a href="{{ route('frontend.products.show', $product->slug) }}" title="{{ $product->name }}">{{ $product->name }}</a>
                                                        </h3>
                                                        <div class="">
                                                            <div class="tp-product-rating d-flex align-items-center mb-1">
                                                                ...
                                                                <div class="tp-product-rating-text"><a href="{{ route('frontend.products.show', $product->slug) }}#product-review">(10 reviews)</a></div>
                                                            </div>
