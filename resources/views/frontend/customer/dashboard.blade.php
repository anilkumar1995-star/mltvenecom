                            ...
                            <div class="bb-profile-content p-4 p-md-5">
                                ...
                                <div class="bb-profile-main">
                                    ...
                                    <div class="row g-4 mb-4">
                                        ...
                                        <div class="col-md-12">
                                            <div class="card h-100 border-0 bg-info bg-opacity-10 border-start border-info border-4 shadow-sm">
                                                <div class="card-body d-flex align-items-center justify-content-between p-4">
                                                    <div class="d-flex align-items-center gap-4">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-1 h4">Vendor Management Panel</h5>
                                                            <p class="text-muted mb-0">Manage your store, products, and view sales analytics.</p>
                                                        </div>
                                                    </div>
                                                    <a href="{{ route('frontend.vendor.dashboard') }}" class="btn btn-info px-4">Go to Vendor Dashboard →</a>
                                                </div>
                                            </div>
                                        </div>
                                        @endif
