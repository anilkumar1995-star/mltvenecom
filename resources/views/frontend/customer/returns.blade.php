                        ...
                        <div class="col-lg-3 col-xl-3 d-none d-lg-block">
                            <div class="bb-customer-sidebar-wrapper h-100 d-flex flex-column">
                                <div class="bb-customer-sidebar flex-1">
                                    ...
                                    @include('frontend.customer.sidebar', ['active' => 'returns'])
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-9 col-xl-9">
                            <div class="bb-profile-content p-4 p-md-5">
                                <div class="bb-profile-header mb-4">
                                    <h1 class="bb-profile-header-title h3 mb-0"> Order Return Requests </h1>
                                </div>
                                <div class="bb-profile-main">
                                    <div class="card border-0 shadow-sm rounded-3">
                                        <div class="card-body p-4 p-md-5 text-center">
                                            ...
                                            <h4 class="fw-semibold text-dark">No return requests found</h4>
                                            <p class="text-muted mb-4">You do not have any active or past order return requests.</p>
                                            <a href="{{ route('frontend.customer.orders') }}" class="btn btn-primary px-4">
                                                View your orders
                                            </a>
                                        </div>
                                    </div>
