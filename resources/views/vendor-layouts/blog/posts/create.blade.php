...
<div class="page-wrapper" id="main-content">
            ...
            <div class="row align-items-center">
                <div class="col">
                    <ol class="breadcrumb mb-0" style="background: transparent; padding: 0;">
                        ...
                        <li class="breadcrumb-item active" style="text-transform: none; font-size: 13px; color: #64748b; font-weight: 400;">Create new post</li>
                    </ol>
                </div>
                <div class="col-auto">
                    <div class="btn-list">
                ...
                <div class="col">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mt-2" style="background: transparent; padding: 0; margin-bottom: 0;">
                            ...
                            <li class="breadcrumb-item active" aria-current="page" style="color: #64748b; font-size: 13px;">Create new post</li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <main class="page-body">
        <div class="container-xl">
            ...
            <form action="{{ route('admin.blog.posts.store') }}" method="POST" id="postForm" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-md-9">
                        <div class="card mb-3 shadow-sm" style="border: 1px solid #e5e7eb; border-radius: 4px;">
                            <div class="card-body p-4">
                                <div class="mb-4">
                                    ...
                                    <input type="text" class="form-control" name="name" id="name" placeholder="Name" required data-counter="250" value="{{ old('name') }}" style="padding: 10px 14px;">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group input-group-flat shadow-none border" style="border-radius: 4px;">
                                        ...
                                        <input type="text" class="form-control ps-0 bg-transparent border-0" name="slug" id="permalink" value="{{ old('slug') }}" placeholder="permalink" readonly style="font-size: 13px; color: #1e293b;">
                                    ...
                                    <div class="mt-1 small" style="font-size: 12px; color: #64748b;">Preview: <a href="#" id="preview-permalink" target="_blank" style="color: #1a73e8; text-decoration: none;">{{ url('blog') }}/</a></div>
                                </div>

                                <div class="mb-4">
                                    <label class="form-label fw-bold mb-2">Description</label>
                                    <textarea class="form-control" name="description" rows="3" placeholder="Short description" data-counter="400" style="padding: 10px 14px;"></textarea>
                                </div>
                                ...
                                <div class="mb-0">
                                    ...
                                    <textarea class="form-control editor-ckeditor" name="content" id="post-content" rows="5">{{ old('content') }}</textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card mb-3 shadow-sm" style="border: 1px solid #e5e7eb; border-radius: 4px;">
                            ...
                            <div class="card-body p-3">
                                <div id="seo-preview" class="border py-3 px-3 shadow-none mb-3" style="border: 1px solid #e5e7eb !important; border-radius: 4px !important; background: #fff;">
                                    <h4 class="mb-1" id="seo-preview-title" style="color: #1a0dab; font-family: arial,sans-serif; font-size: 18px; font-weight: 400; line-height: 1.2; cursor: pointer;">Post Name</h4>
                                    <div class="mb-1" id="seo-preview-url" style="color: #006621; font-family: arial,sans-serif; font-size: 14px; line-height: 1.2;">{{ url('blog') }}/permalink</div>
                                    <p class="mb-0" id="seo-preview-description" style="color: #4d5156; font-family: arial,sans-serif; font-size: 14px; line-height: 1.4;">Short description for the post will appear here in search engine results.</p>
                                </div>
                                
                                <div id="seo-meta-fields" style="display: none;" class="mt-4 pt-4 border-top">
                                    <div class="mb-4">
                                        <label class="form-label fw-bold mb-2">SEO Title</label>
                                        <input type="text" class="form-control" name="seo_title" id="seo_title" placeholder="SEO Title" data-counter="70" style="padding: 10px 14px;">
                                    </div>
                                    <div class="mb-4">
                                        <label class="form-label fw-bold mb-2">SEO Description</label>
                                        <textarea class="form-control" name="seo_description" id="seo_description" rows="3" placeholder="SEO Description" data-counter="160" style="padding: 10px 14px;"></textarea>
                                    </div>
                                    <div class="mb-4">
                                        ...
                                        <div class="image-box text-center border rounded p-4 bg-light cursor-pointer" onclick="document.getElementById('seo_image_input').click();" style="border: 2px dashed #cbd5e1 !important; background: #f8fafc;">
                                            ...
                                            <img id="seo-image-preview" src="#" alt="Preview" style="max-height: 100px; display: none; margin: 0 auto;" class="mb-2 rounded">
                    ...
                    <div class="col-md-3">
                            ...
                            <div class="card-body p-3">
                                ...
                                <div class="category-list-wrapper scrollable" style="max-height: 250px; overflow-y: auto; padding-right: 5px;">
                                    ...
                                    <div class="form-check mb-2 category-item" data-name="{{ strtolower($category->name) }}">
                                        <input class="form-check-input mt-1" type="checkbox" name="categories[]" value="{{ $category->id }}" id="cat-{{ $category->id }}" {{ is_array(old('categories')) && in_array($category->id, old('categories')) ? 'checked' : '' }}>
                            ...
                            <div class="card-body p-3 text-center">
                                <div class="image-box-wrapper mb-2">
                                    <div class="image-placeholder-box cursor-pointer" onclick="document.getElementById('image').click();" style="width: 100%; height: 160px; border: 1px solid #e2e8f0; background: #f8fafc; display: flex; align-items: center; justify-content: center; border-radius: 4px;">
                                        ...
                                        <img id="image-preview" src="#" alt="Preview" style="max-width: 100%; max-height: 100%; display: none;" class="rounded">
                                    </div>
                                </div>
                                <div class="d-flex justify-content-center gap-1 align-items-center mt-2" style="font-size: 13px;">
                                    <a href="#" class="text-primary text-decoration-none fw-bold" onclick="document.getElementById('image').click(); return false;">Choose image</a>
                        ...
                        <div class="card mb-3 shadow-sm" style="border: 1px solid #e5e7eb; border-radius: 4px;">
                            ...
                            <div class="card-body p-3">
                                <input type="text" class="form-control" name="post_tags" placeholder="Write some tags" id="tag" style="padding: 8px 12px; font-size: 13px;">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            let html = `
                <div class="faq-item mb-4 p-4 bg-white shadow-sm" id="faq-item-${faqIndex}" style="border: 1px solid #e2e8f0; border-radius: 8px;">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="faq_schema_config[${faqIndex}][question]" class="form-control" placeholder="Question">
                    </div>
                    <div>
                        <label class="form-label fw-bold">Answer</label>
                        <textarea name="faq_schema_config[${faqIndex}][answer]" class="form-control" rows="3" placeholder="Answer"></textarea>
                    </div>
                </div>
            `;
