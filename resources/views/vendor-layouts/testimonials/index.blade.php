                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">
                                    <h1 class="mb-0 d-inline-block fs-6 lh-1 text-dark">Testimonials</h1>
                                </li>
                            </ol>
                        </nav>
                    </div>
        ...
        <div class="container-xl">
            ...
            <div class="card has-actions has-filter">
                ...
                @section('table_actions')
                    <a href="{{ route('admin.testimonials.create') }}" class="btn btn-primary d-flex align-items-center">
                ...
                <div class="card-table mt-1">
                    <div class="table-responsive">
                        <table class="table card-table table-vcenter table-hover datatable" id="testimonialsTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="fw-bold">
                                        <a href="{{ route('admin.testimonials.edit', $item->id) }}" class="text-dark text-decoration-none">{{ $item->name ?? 'N/A' }}</a>
                                    </td>
                                    <td>{{ $item->company ?? '-' }}</td>
                                    <td class="text-center">
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group">
                                            <a href="{{ route('admin.testimonials.edit', $item->id) }}" class="btn btn-sm btn-outline-info" title="Edit">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <button type="button" class="btn btn-sm btn-outline-danger delete-confirm-btn" 
                                                data-url="{{ route('admin.testimonials.destroy', $item->id) }}"
                                                title="Delete">
...
@push('scripts')
    @include('admin-layouts.partials.table-scripts', [
        'tableId'       => 'testimonialsTable',
        'bulkDeleteUrl' => route('admin.testimonials.bulk-delete')
    ])
@endpush
