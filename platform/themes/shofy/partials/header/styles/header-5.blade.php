                    ...
                    <div class="col-xxl-2 col-xl-3 col-6">
                        <div class="tp-header-left-5 d-flex align-items-center">
                            <div class="tp-header-hamburger-5 mr-15 d-none d-xl-block">
                                <button class="tp-hamburger-btn-2 tp-hamburger-toggle" aria-label="{{ __('Toggle categories menu') }}">
                                    <span></span>
                                    <span></span>
                                    <span></span>
                                </button>
                            ...
                            <div class="tp-header-hamburger-5 mr-15 d-xl-none">
                                <button class="tp-hamburger-btn-2 tp-offcanvas-open-btn" aria-label="{{ __('Open menu') }}">
                                    <span></span>
                                    <span></span>
                                    <span></span>
                                </button>
