...
/***/ "./platform/themes/shofy/assets/js/owl-carousel-init.js"
/*!**************************************************************!*\
  !*** ./platform/themes/shofy/assets/js/owl-carousel-init.js ***!
  \**************************************************************/
() {
...
$(function () {
  ...
  var initOwlCarousel = function initOwlCarousel() {
    // Helper function to initialize Owl Carousel with data attributes
    var initOwlSlider = function initOwlSlider(selector) {
      $(selector).each(function () {
        ...
        var autoplay = $slider.data('owl-auto') === 'true' || $slider.data('owl-auto') === true;
        var loop = $slider.data('owl-loop') === 'true' || $slider.data('owl-loop') === true;
        var autoplaySpeed = parseInt($slider.data('owl-speed')) || 5000;
        var gap = parseInt($slider.data('owl-gap')) || 0;
        var nav = $slider.data('owl-nav') === 'true' || $slider.data('owl-nav') === true;
        var dots = $slider.data('owl-dots') === 'true' || $slider.data('owl-dots') === true;
        var items = parseInt($slider.data('owl-item')) || 1;
        var itemsXs = parseInt($slider.data('owl-item-xs')) || items;
        var itemsSm = parseInt($slider.data('owl-item-sm')) || items;
        var itemsMd = parseInt($slider.data('owl-item-md')) || items;
        var itemsLg = parseInt($slider.data('owl-item-lg')) || items;
        var duration = parseInt($slider.data('owl-duration')) || 1000;
        var mouseDrag = $slider.data('owl-mousedrag') === 'on' || $slider.data('owl-mousedrag') === true;
        var animateOut = $slider.data('owl-animate-out') || 'fadeOut';
        var animateIn = $slider.data('owl-animate-in') || 'fadeIn';
        ...
        $slider.owlCarousel({
          ...
          onChanged: function onChanged(event) {
            ...
            if ($owl.hasClass('tp-slider-variation')) {
              var $activeSlide = $owl.find('.owl-item.active .tp-slider-item');
...
/***/ "./platform/themes/shofy/assets/js/slider-autoplay-helper.js"
/*!*******************************************************************!*\
  !*** ./platform/themes/shofy/assets/js/slider-autoplay-helper.js ***!
  \*******************************************************************/
() {
...
window.SliderAutoplayHelper = {
   ...
   */
  getAutoplayConfig: function getAutoplayConfig($element) {
    return {
   ...
   */
  applySwiperAutoplayConfig: function applySwiperAutoplayConfig(swiperConfig, autoplayConfig) {
   ...
   */
  initSliderWithAutoplay: function initSliderWithAutoplay(selector, baseSwiperConfig, initSwiperSlider) {
    $(selector).each(function (index, element) {
      var $element = $(element);
      var autoplayConfig = SliderAutoplayHelper.getAutoplayConfig($element);

      // Clone the base config to avoid modifying the original
      var swiperConfig = Object.assign({}, baseSwiperConfig);
   ...
   */
  initSliderWithAutoplayAndItems: function initSliderWithAutoplayAndItems(selector, baseSwiperConfig, initSwiperSlider) {
    var itemsDataAttribute = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 'items-per-view';
    $(selector).each(function (index, element) {
      var $element = $(element);
      var autoplayConfig = SliderAutoplayHelper.getAutoplayConfig($element);
      ...
      var itemsPerView = $element.data(itemsDataAttribute);
      if (itemsPerView) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _slider_autoplay_helper_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./slider-autoplay-helper.js */ "./platform/themes/shofy/assets/js/slider-autoplay-helper.js");
/* harmony import */ var _slider_autoplay_helper_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_slider_autoplay_helper_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _owl_carousel_init_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./owl-carousel-init.js */ "./platform/themes/shofy/assets/js/owl-carousel-init.js");
/* harmony import */ var _owl_carousel_init_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_owl_carousel_init_js__WEBPACK_IMPORTED_MODULE_1__);
...
$(function () {
  ...
  initCommonJS();
  var $menuStyle3 = $('.main-menu.menu-style-3 > nav > ul');
  ...
  var initSwiperSlider = function initSwiperSlider(element, options) {
    var $element = $(element);
    if (!$element.length) {
      return;
    }
  ...
  var initSwiper = function initSwiper() {
    ...
    $('.tp-product-arrival-active').each(function (index, element) {
      var $element = $(element);
      var sliderId = $element.data('slider-id') || $element.attr('id');
      if (!sliderId) {
      ...
      // Read autoplay settings from data attributes
      var isAutoplay = $element.data('autoplay') === true || $element.data('autoplay') === 'true';
      var autoplaySpeed = parseInt($element.data('autoplay-speed')) || 3000;
      var isLoop = $element.data('loop') !== false && $element.data('loop') !== 'false';
      var swiperConfig = {
        slidesPerView: 4,
        spaceBetween: 30,
        loop: isLoop,
        pagination: {
          el: ".tp-arrival-dot-".concat(sliderId),
          clickable: true,
          renderBullet: function renderBullet(index, className) {
        ...
        // Navigation arrows
        navigation: {
          nextEl: ".tp-arrival-next-".concat(sliderId),
          prevEl: ".tp-arrival-prev-".concat(sliderId)
        },
        breakpoints: {
          1200: {
            slidesPerView: $element.data('items-per-view') || 4
    ...
    $('.tp-product-related-slider-active').each(function (index, element) {
      var itemsPerView = $(element).data('items-per-view') || 4;
      initSwiperSlider(element, {
    ...
    $('.tp-category-slider-active-4').each(function (index, element) {
      ...
      var autoplaySpeed = parseInt($element.data('autoplay-speed')) || 3000;
      var isLoop = $element.data('loop') !== false && $element.data('loop') !== 'false';
      var itemsPerView = $element.data('items-per-view') || 5;
      var swiperConfig = {
        slidesPerView: itemsPerView,
        spaceBetween: 25,
        loop: isLoop,
  ...
  var initProductTabNavigation = function initProductTabNavigation() {
    var $tabButtons = $('.tp-product-details-tab-nav .nav-tabs button[data-bs-toggle="tab"]');
    ...
    var hashToTabMap = Object.fromEntries(Object.entries(tabHashMap).map(function (_ref2) {
      var _ref3 = _slicedToArray(_ref2, 2),
        key = _ref3[0],
        value = _ref3[1];
      return [value, key];
    }));
    var updateTabMarker = function updateTabMarker() {
      var marker = document.querySelector('#productTabMarker');
      if (!marker) return;
      var activeTab = document.querySelector('.tp-product-tab button.active');
      if (!activeTab) return;
    ...
    var activateTabFromHash = function activateTabFromHash() {
      ...
      if (hash && hashToTabMap[hash]) {
        ...
        if ($targetTab.length && !$targetTab.hasClass('active')) {
          var tabTrigger = new bootstrap.Tab($targetTab[0]);
          tabTrigger.show();
          setTimeout(updateTabMarker, 100);
          setTimeout(function () {
            var $tabNav = $('.tp-product-details-tab-nav');
            if ($tabNav.length) {
              var _headerHeight = $('.header-sticky').outerHeight() || 0;
              var scrollPosition = $tabNav.offset().top - _headerHeight - 20;
              $('html, body').animate({
...
/******/ 	__webpack_require__.O(undefined, ["themes/shofy/css/theme","themes/shofy-beauty/css/theme","themes/shofy-fashion/css/theme","vendor/core/core/base/css/libraries/select2.rtl","vendor/core/core/base/css/core.rtl","vendor/core/core/base/css/crop-image","vendor/core/core/base/css/tree-category","vendor/core/core/base/css/error-pages","vendor/core/core/base/css/libraries/select2","vendor/core/core/base/css/core","vendor/core/core/media/css/media","themes/shofy-grocery/css/theme","vendor/core/core/setting/css/admin-email","vendor/core/core/table/css/table","vendor/core/packages/get-started/css/get-started","vendor/core/packages/installer/css/style","vendor/core/packages/menu/css/menu","vendor/core/packages/page/css/visual-builder","vendor/core/packages/revision/css/revision","vendor/core/packages/seo-helper/css/seo-helper","vendor/core/packages/shortcode/css/shortcode","vendor/core/packages/slug/css/slug","vendor/core/packages/theme/css/guideline","vendor/core/packages/theme/css/admin-bar","vendor/core/packages/theme/css/theme-options","vendor/core/packages/widget/css/widget","vendor/core/plugins/announcement/css/announcement","vendor/core/plugins/backup/css/backup","vendor/core/plugins/contact/css/contact-public","vendor/core/plugins/contact/css/contact","vendor/core/plugins/ecommerce/css/front-theme-rtl","vendor/core/plugins/ecommerce/css/front-theme","vendor/core/plugins/ecommerce/css/front-review","vendor/core/plugins/ecommerce/css/front-faq","vendor/core/plugins/ecommerce/css/front-ecommerce-rtl","vendor/core/plugins/ecommerce/css/front-ecommerce-missing-bootstrap","vendor/core/plugins/ecommerce/css/front-ecommerce","vendor/core/plugins/ecommerce/css/front-auth","vendor/core/plugins/ecommerce/css/widget","vendor/core/plugins/ecommerce/css/order-return","vendor/core/plugins/ecommerce/css/report","vendor/core/plugins/ecommerce/css/customer","vendor/core/plugins/ecommerce/css/review","vendor/core/plugins/ecommerce/css/currencies","vendor/core/plugins/ecommerce/css/ecommerce-product-attributes","vendor/core/plugins/ecommerce/css/ecommerce","vendor/core/plugins/faq/css/faq","vendor/core/plugins/gallery/css/admin-gallery","vendor/core/plugins/gallery/css/object-gallery","vendor/core/plugins/gallery/css/gallery","vendor/core/plugins/language/css/language-public","vendor/core/plugins/language/css/language","vendor/core/plugins/marketplace/css/marketplace-rtl","vendor/core/plugins/marketplace/css/marketplace","vendor/core/plugins/newsletter/css/newsletter","vendor/core/plugins/payment/css/payment-setting","vendor/core/plugins/payment/css/payment","vendor/core/plugins/sale-popup/css/sale-popup","vendor/core/plugins/simple-slider/css/simple-slider","vendor/core/plugins/social-login/css/social-login","vendor/core/plugins/translation/css/translation","themes/shofy/css/theme-rtl"], () => (__webpack_require__("./platform/packages/page/resources/sass/visual-builder.scss")))
...
/******/ 	__webpack_require__.O(undefined, ["themes/shofy/css/theme","themes/shofy-beauty/css/theme","themes/shofy-fashion/css/theme","vendor/core/core/base/css/libraries/select2.rtl","vendor/core/core/base/css/core.rtl","vendor/core/core/base/css/crop-image","vendor/core/core/base/css/tree-category","vendor/core/core/base/css/error-pages","vendor/core/core/base/css/libraries/select2","vendor/core/core/base/css/core","vendor/core/core/media/css/media","themes/shofy-grocery/css/theme","vendor/core/core/setting/css/admin-email","vendor/core/core/table/css/table","vendor/core/packages/get-started/css/get-started","vendor/core/packages/installer/css/style","vendor/core/packages/menu/css/menu","vendor/core/packages/page/css/visual-builder","vendor/core/packages/revision/css/revision","vendor/core/packages/seo-helper/css/seo-helper","vendor/core/packages/shortcode/css/shortcode","vendor/core/packages/slug/css/slug","vendor/core/packages/theme/css/guideline","vendor/core/packages/theme/css/admin-bar","vendor/core/packages/theme/css/theme-options","vendor/core/packages/widget/css/widget","vendor/core/plugins/announcement/css/announcement","vendor/core/plugins/backup/css/backup","vendor/core/plugins/contact/css/contact-public","vendor/core/plugins/contact/css/contact","vendor/core/plugins/ecommerce/css/front-theme-rtl","vendor/core/plugins/ecommerce/css/front-theme","vendor/core/plugins/ecommerce/css/front-review","vendor/core/plugins/ecommerce/css/front-faq","vendor/core/plugins/ecommerce/css/front-ecommerce-rtl","vendor/core/plugins/ecommerce/css/front-ecommerce-missing-bootstrap","vendor/core/plugins/ecommerce/css/front-ecommerce","vendor/core/plugins/ecommerce/css/front-auth","vendor/core/plugins/ecommerce/css/widget","vendor/core/plugins/ecommerce/css/order-return","vendor/core/plugins/ecommerce/css/report","vendor/core/plugins/ecommerce/css/customer","vendor/core/plugins/ecommerce/css/review","vendor/core/plugins/ecommerce/css/currencies","vendor/core/plugins/ecommerce/css/ecommerce-product-attributes","vendor/core/plugins/ecommerce/css/ecommerce","vendor/core/plugins/faq/css/faq","vendor/core/plugins/gallery/css/admin-gallery","vendor/core/plugins/gallery/css/object-gallery","vendor/core/plugins/gallery/css/gallery","vendor/core/plugins/language/css/language-public","vendor/core/plugins/language/css/language","vendor/core/plugins/marketplace/css/marketplace-rtl","vendor/core/plugins/marketplace/css/marketplace","vendor/core/plugins/newsletter/css/newsletter","vendor/core/plugins/payment/css/payment-setting","vendor/core/plugins/payment/css/payment","vendor/core/plugins/sale-popup/css/sale-popup","vendor/core/plugins/simple-slider/css/simple-slider","vendor/core/plugins/social-login/css/social-login","vendor/core/plugins/translation/css/translation","themes/shofy/css/theme-rtl"], () => (__webpack_require__("./platform/core/base/resources/sass/core.scss")))
