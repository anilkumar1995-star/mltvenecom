                    ...
                    <div class="page-pretitle">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" href="{{ route('admin.productlables.Index') }}"
                                    aria-current="page">
                                    <h1 class="mb-0 d-inline-block fs-6 lh-1">Product Lables</h1>
                                </li>
                            </ol>
                        </nav>
                    </div>
    ...
    <main class="page-body page-content">
        <div class="container-xl">
            <div id="filter-section" class="card mb-3" style="display: none;">
                <div class="card-body">
                    <form action="{{ route('admin.productlables.Index') }}" method="GET" class="row g-3">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4 d-flex align-items-end">
                            ...
                            <a href="{{ route('admin.productlables.Index') }}" class="btn btn-light">Reset</a>
                        </div>
                    </form>
                </div>
            </div>
                        ...
                        <div class="w-100 justify-content-between d-flex flex-wrap align-items-center gap-1">
                            <div class="d-flex flex-wrap flex-md-nowrap align-items-center gap-1">
                                ...
                                <div class="table-search-input">
                                    <form action="{{ route('admin.productlables.Index') }}" method="GET">
                            ...
                            <div
                                ...
                                <a href="{{ route('admin.productlables.create') }}" class="btn btn-primary">
    ...
    function deleteItem(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: '{{ route("admin.productlables.Delete") }}',
                    type: 'POST',
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '#bulkDeleteBtn', function(e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: '{{ route("admin.productlables.bulk-delete") }}',
                        type: 'POST',
