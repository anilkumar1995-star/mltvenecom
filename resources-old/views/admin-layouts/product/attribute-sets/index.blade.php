...
@section('content')
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">
                                        <h1 class="mb-0 d-inline-block fs-6 lh-1">Product attributes</h1>
                                    </li>
                                </ol>
                            </nav>
        ...
        <main class="page-body page-content">
            <div class="container-xl">
                <div id="filter-section" class="card mb-3" style="display: none;">
                    <div class="card-body">
                        <form action="{{ route('admin.attribute-sets.index') }}" method="GET" class="row g-3">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4 d-flex align-items-end">
                                ...
                                <a href="{{ route('admin.attribute-sets.index') }}" class="btn btn-light">Reset</a>
                            </div>
                        </form>
                    </div>
                </div>
                        ...
                        <div class="card-header">
                            <div class="w-100 justify-content-between d-flex flex-wrap align-items-center gap-1">
                                <div class="d-flex flex-wrap flex-md-nowrap align-items-center gap-1">
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <div class="table-search-input">
                                            <form action="{{ route('admin.attribute-sets.index') }}" method="GET">
                                ...
                                <div class="d-flex flex-column flex-sm-row align-items-stretch align-items-sm-center gap-1 table-action-buttons">
                                    <a href="{{ route('admin.attribute-sets.create') }}" class="btn btn-primary">
                                ...
                                <table class="table card-table table-vcenter table-hover datatable" id="myTable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-start">
                                                <a href="{{ route('admin.attribute-sets.edit', $row->id) }}">
                                                    {{ $row->title }}
                                                </a>
                                            </td>
                                            <td>{{ $row->slug }}</td>
                                        ...
                                        @empty
                                        <tr>
                                            <td colspan="8" class="text-center">No attribute sets found.</td>
                                        </tr>
                                        @endforelse
                                    </tbody>
                                </table>
    ...
    function deleteItem(id) {
        Swal.fire({
            title: "Are you sure?",
            text: "Do you really want to delete this attribute set?",
            icon: "warning",
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: '{{ route("admin.attribute-sets.delete") }}',
                    type: 'POST',
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '#bulkDeleteBtn', function(e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: '{{ route("admin.attribute-sets.bulk-delete") }}',
                        type: 'POST',
